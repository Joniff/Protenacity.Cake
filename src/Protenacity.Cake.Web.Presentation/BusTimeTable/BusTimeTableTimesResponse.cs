...
public class BusTimeTableTimesResponse
{
    ...
    public required ServiceRecord Service { get; set; }

    [JsonPropertyName("operationalDay")]
    public required OperationalDayRecord OperationalDay { get; set; }

    [JsonPropertyName("times")]
    public required IEnumerable<TimeRecord> Times { get; set; }
