...
public partial class EditorCategoriesEmbeddedSettings
{
    ...
    public EditorTabStripPlacements PlacementTyped => EditorTabStripPlacements.ParseByDescription(this.Placement) ?? EditorTabStripPlacements.Left;
