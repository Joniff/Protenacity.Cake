import { css as Ve, property as qe, customElement as de, LitElement as fe, html as _t, state as X } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as Gi } from "@umbraco-cms/backoffice/element-api";
import { UMB_CURRENT_USER_CONTEXT as ji } from "@umbraco-cms/backoffice/current-user";
var $i = Object.defineProperty, Ki = Object.getOwnPropertyDescriptor, Ge = (t, e, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Ki(e, i) : e, s = t.length - 1, r; s >= 0; s--)
    (r = t[s]) && (o = (n ? r(e, i, o) : r(o)) || o);
  return n && o && $i(e, i, o), o;
};
function Yi(t, e) {
  let i;
  return function(...n) {
...
let It = class extends fe {
  constructor() {
    super(...arguments), this.data = [], this.placeholder = "";
  }
  firstUpdated(t) {
    var e, i;
    this.input = (e = this.shadowRoot) == null ? void 0 : e.getElementById("searchField"), this.list = (i = this.shadowRoot) == null ? void 0 : i.getElementById("suggestions"), this.input.addEventListener("input", Yi(200, this.onEntry.bind(this))), this.input.addEventListener("search", () => {
      this.input.value.length === 0 && this.reset();
    });
  }
  async getSuggestion(t) {
    return console.warn("You need to implement your own getSuggestion method. Searching for: " + t), [];
  }
  reset() {
    this.data = [], this.list.innerHTML = '<option value="">', this.input.setCustomValidity("");
  }
  async onEntry(t) {
    var i;
    const e = this.input.value.length >= this.input.minLength && this.input.value.toLowerCase();
    if (e) {
      if (t.inputType == "insertReplacementText" || t.inputType == null) {
        const n = (i = [...this.list.options].filter((o) => o.value === this.input.value)) == null ? void 0 : i[0];
        n && (this.value = JSON.parse(n.dataset.obj), this.dispatchEvent(new CustomEvent("autoSuggestSelect", {})), this.reset());
        return;
      }
      this.data = await this.getSuggestion(e), this.list.innerHTML = this.data.map((n) => `<option value="${n.name}" data-obj='${n ? JSON.stringify(n) : ""}'>${n.name}</option>`).join("");
    }
  }
  render() {
    return _t`
...
It = Ge([
  de("posm-openstreetmap-auto-suggest")
], It);
/* @preserve
...
var te = Object.create || /* @__PURE__ */ function() {
  function t() {
  }
  return function(e) {
...
var Ji = 0;
function w(t) {
  return "_leaflet_id" in t || (t._leaflet_id = ++Ji), t._leaflet_id;
}
function Qi(t, e, i) {
  var n, o, s, r;
  return r = function() {
...
function k(t, e) {
  Object.prototype.hasOwnProperty.call(t, "options") || (t.options = t.options ? te(t.options) : {});
  for (var i in e)
    t.options[i] = e[i];
  return t.options;
}
...
var en = /\{ *([\w_ -]+) *\}/g;
function nn(t, e) {
  return t.replace(en, function(i, n) {
    var o = e[n];
    if (o === void 0)
...
var ze = 0;
function Ke(t) {
  var e = +/* @__PURE__ */ new Date(), i = Math.max(0, 16 - (e - ze));
  return ze = e + i, window.setTimeout(t, i);
}
var ke = window.requestAnimationFrame || ee("RequestAnimationFrame") || Ke, on = window.cancelAnimationFrame || ee("CancelAnimationFrame") || ee("CancelRequestAnimationFrame") || function(t) {
...
rt.extend = function(t) {
  ...
  }, i = e.__super__ = this.prototype, n = te(i);
  n.constructor = e, e.prototype = n;
  for (var o in this)
    Object.prototype.hasOwnProperty.call(this, o) && o !== "prototype" && o !== "__super__" && (e[o] = this[o]);
  return t.statics && b(e, t.statics), t.includes && (sn(t.includes), b.apply(null, [n].concat(t.includes))), b(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? te(i.options) : {}, b(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
...
_.prototype = {
  ...
  toString: function() {
    return "Point(" + tt(this.x) + ", " + tt(this.y) + ")";
  }
};
function f(t, e, i) {
  return t instanceof _ ? t : J(t) ? new _(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new _(t.x, t.y) : new _(t, e, i);
}
function z(t, e) {
  if (t)
...
z.prototype = {
  ...
  extend: function(t) {
    ...
    if (!t)
      return this;
    if (t instanceof _ || typeof t[0] == "number" || "x" in t)
      e = i = f(t);
  ...
  contains: function(t) {
    var e, i;
    return typeof t[0] == "number" || t instanceof _ ? t = f(t) : t = D(t), t instanceof z ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
  },
...
F.prototype = {
  ...
  extend: function(t) {
    ...
    if (t instanceof P)
      ...
      return t ? this.extend(v(t) || Z(t)) : this;
  ...
  // Returns `true` if the rectangle contains the given point.
  contains: function(t) {
    typeof t[0] == "number" || t instanceof P || "lat" in t ? t = v(t) : t = Z(t);
    var e = this._southWest, i = this._northEast, n, o;
  ...
  equals: function(t, e) {
    return t ? (t = Z(t), this._southWest.equals(t.getSouthWest(), e) && this._northEast.equals(t.getNorthEast(), e)) : !1;
  },
  // @method isValid(): Boolean
  // Returns `true` if the bounds are properly initialized.
  isValid: function() {
...
P.prototype = {
  ...
  // Returns a string representation of the point (for debugging purposes).
  toString: function(t) {
    return "LatLng(" + tt(this.lat, t) + ", " + tt(this.lng, t) + ")";
  },
  // @method distanceTo(otherLatLng: LatLng): Number
  // Returns the distance (in meters) to the given `LatLng` calculated using the [Spherical Law of Cosines](https://en.wikipedia.org/wiki/Spherical_law_of_cosines).
  distanceTo: function(t) {
    return st.distance(this, v(t));
  },
  // @method wrap(): LatLng
...
var pe = document.documentElement.style, me = "ActiveXObject" in window, an = me && !document.addEventListener, Qe = "msLaunchUri" in navigator && !("documentMode" in document), hn = Y("webkit"), un = Y("android"), ln = Y("android 2") || Y("android 3"), cn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10);
un && Y("Google") && cn < 537 && "AudioNode" in window;
var ti = !!window.opera, ei = !Qe && Y("chrome");
Y("gecko");
var dn = !ei && Y("safari"), fn = Y("phantom"), _n = "OTransition" in pe;
navigator.platform.indexOf("Win");
var ii = me && "transition" in pe, pn = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !ln, mn = "MozPerspective" in pe, gn = !window.L_DISABLE_3D && (ii || pn || mn) && !_n && !fn, ni = typeof orientation < "u" || Y("mobile"), oi = !window.PointerEvent && window.MSPointerEvent, si = !!(window.PointerEvent || oi), ri = "ontouchstart" in window || !!window.TouchEvent, vn = !window.L_NO_TOUCH && (ri || si), yn = ni && ti, xn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, wn = function() {
  var t = !1;
  try {
...
}(), ge = !!(document.createElementNS && Xe("svg").createSVGRect), Ln = !!ge && function() {
...
}(), Tn = navigator.platform.indexOf("Mac") === 0, Mn = navigator.platform.indexOf("Linux") === 0;
function Y(t) {
...
var c = {
  ...
  mac: Tn,
  linux: Mn
}, ai = c.msPointer ? "MSPointerDown" : "pointerdown", hi = c.msPointer ? "MSPointerMove" : "pointermove", ui = c.msPointer ? "MSPointerUp" : "pointerup", li = c.msPointer ? "MSPointerCancel" : "pointercancel", ie = {
  touchstart: ai,
  touchmove: hi,
  touchend: ui,
  touchcancel: li
...
function Cn(t, e, i) {
  return e === "touchstart" && En(), Oe[e] ? (i = Oe[e].bind(this, i), t.addEventListener(ie[e], i, !1), i) : (console.warn("wrong event specified:", e), E);
}
function zn(t, e, i) {
  if (!ie[e]) {
...
function En() {
  Be || (document.addEventListener(ai, kn, !0), document.addEventListener(hi, Sn, !0), document.addEventListener(ui, Ae, !0), document.addEventListener(li, Ae, !0), Be = !0);
}
function Et(t, e) {
...
function Zn(t, e) {
  e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && I(e), Et(t, e);
}
function On(t) {
  var e = {}, i, n;
  for (n in t)
...
), Nn = Zt === "webkitTransition" || Zt === "OTransition" ? Zt + "End" : "transitionend";
function Rn(t) {
...
function m(t, e) {
  if (t.classList !== void 0)
    for (var i = pt(e), n = 0, o = i.length; n < o; n++)
      t.classList.add(i[n]);
  else if (!di(t, e)) {
    var s = ve(t);
    fi(t, (s ? s + " " : "") + e);
...
function O(t, e) {
  t.classList !== void 0 ? t.classList.remove(e) : fi(t, je((" " + ve(t) + " ").replace(" " + e + " ", " ")));
}
function fi(t, e) {
...
function G(t, e) {
  "opacity" in t.style ? t.style.opacity = e : "filter" in t.style && Dn(t, e);
}
function Dn(t, e) {
...
function B(t, e) {
  t._leaflet_pos = e, c.any3d ? yt(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
}
function xt(t) {
...
if ("onselectstart" in document)
  Dt = function() {
    p(window, "selectstart", I);
  }, Wt = function() {
    T(window, "selectstart", I);
  };
else {
  var Lt = ye(
  ...
  Dt = function() {
    ...
    Lt && (document.documentElement.style[Lt] = Jt, Jt = void 0);
  };
}
function _i() {
  p(window, "dragstart", I);
}
function pi() {
  T(window, "dragstart", I);
}
var Ot, oe;
function mi(t) {
  for (; t.tabIndex === -1; )
    t = t.parentNode;
  t.style && (se(), Ot = t, oe = t.style.outlineStyle, t.style.outlineStyle = "none", p(window, "keydown", se));
}
function se() {
  Ot && (Ot.style.outlineStyle = oe, Ot = void 0, oe = void 0, T(window, "keydown", se));
}
function Wn(t) {
  do
    t = t.parentNode;
...
function T(t, e, i, n) {
  if (arguments.length === 1)
    ...
    for (var o in e)
      he(t, o, e[o], i);
  else if (e = pt(e), arguments.length === 2)
    Ie(t, function(a) {
      return $e(e, a) !== -1;
    });
  else
...
function ae(t, e, i, n) {
  ...
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? s = Cn(t, e, s) : c.touch && e === "dblclick" ? s = An(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(re[e] || e, s, c.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
    a = a || window.event, yi(t, a) && r(a);
  }, t.addEventListener(re[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[K] = t[K] || {}, t[K][o] = s;
}
function he(t, e, i, n, o) {
  ...
  if (!s)
    return this;
  !c.touchNative && c.pointer && e.indexOf("touch") === 0 ? zn(t, e, s) : c.touch && e === "dblclick" ? In(t, s) : "removeEventListener" in t ? t.removeEventListener(re[e] || e, s, !1) : t.detachEvent("on" + e, s), t[K][o] = null;
}
function mt(t) {
  return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
}
function vi(t) {
  return ae(t, "wheel", mt), this;
}
function Gt(t) {
  return p(t, "mousedown touchstart dblclick contextmenu", mt), t._leaflet_disable_click = !0, this;
}
function I(t) {
  return t.preventDefault ? t.preventDefault() : t.returnValue = !1, this;
}
function wt(t) {
  return I(t), mt(t), this;
}
function Fn(t) {
  if (t.composedPath)
...
function Hn(t, e) {
  ...
  var i = gi(e), n = i.boundingClientRect;
  return new _(
...
var Un = c.linux && c.chrome ? window.devicePixelRatio : c.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
function Vn(t) {
  return c.edge ? t.wheelDeltaY / 2 : (
    // Don't trust window-geometry-based delta
    t.deltaY && t.deltaMode === 0 ? -t.deltaY / Un : (
      // Pixels
...
var qn = Vt.extend({
  ...
  setZoomAround: function(t, e, i) {
    var n = this.getZoomScale(e), o = this.getSize().divideBy(2), s = t instanceof _ ? t : this.latLngToContainerPoint(t), r = s.subtract(o).multiplyBy(1 - 1 / n), a = this.containerPointToLatLng(o.add(r));
    return this.setView(a, e, { zoom: i });
  },
  _getBoundsCenterZoom: function(t, e) {
    e = e || {}, t = t.getBounds ? t.getBounds() : Z(t);
    var i = f(e.paddingTopLeft || e.padding || [0, 0]), n = f(e.paddingBottomRight || e.padding || [0, 0]), o = this.getBoundsZoom(t, !1, i.add(n));
  ...
  panBy: function(t, e) {
    if (t = f(t).round(), e = e || {}, !t.x && !t.y)
      return this.fire("moveend");
    if (e.animate !== !0 && !this.getSize().contains(t))
      return this._resetView(this.unproject(this.project(this.getCenter()).add(t)), this.getZoom()), this;
    if (this._panAnim || (this._panAnim = new qn(), this._panAnim.on({
  ...
  flyTo: function(t, e, i) {
    ...
    t = v(t), e = e === void 0 ? r : e;
    var a = Math.max(s.x, s.y), h = a * this.getZoomScale(r, e), u = o.distanceTo(n) || 1, l = 1.42, d = l * l;
    function g(S) {
      var St = S ? -1 : 1, Hi = S ? h : a, Ui = h * h - a * a + St * d * d * u * u, Vi = 2 * Hi * d * u, Yt = Ui / Vi, Ce = Math.sqrt(Yt * Yt + 1) - Yt, qi = Ce < 1e-9 ? -18 : Math.log(Ce);
      return qi;
    }
    function N(S) {
    ...
    var R = g(0);
    function ft(S) {
      return a * (A(R) / A(R + l * S));
    }
    function Ri(S) {
      return a * (A(R) * U(R + l * S) - N(R)) / d;
    }
    function Di(S) {
      return 1 - Math.pow(1 - S, 1.5);
    }
    var Wi = Date.now(), Te = (g(1) - R) / l, Fi = i.duration ? 1e3 * i.duration : 1e3 * Te * 0.8;
    function Me() {
      var S = (Date.now() - Wi) / Fi, St = Di(S) * Te;
      S <= 1 ? (this._flyToFrame = W(Me, this), this._move(
        this.unproject(n.add(o.subtract(n).multiplyBy(Ri(St) / u)), r),
        this.getScaleZoom(a / ft(St), r),
        { flyTo: !0 }
      )) : this._move(t, e)._moveEnd(!0);
    }
    return this._moveStart(!0, i.noMoveStart), Me.call(this), this;
  },
  ...
  setMaxBounds: function(t) {
    return t = Z(t), this.listens("moveend", this._panInsideMaxBounds) && this.off("moveend", this._panInsideMaxBounds), t.isValid() ? (this.options.maxBounds = t, this._loaded && this._panInsideMaxBounds(), this.on("moveend", this._panInsideMaxBounds)) : (this.options.maxBounds = null, this);
  },
  ...
  panInside: function(t, e) {
    e = e || {};
    var i = f(e.paddingTopLeft || e.padding || [0, 0]), n = f(e.paddingBottomRight || e.padding || [0, 0]), o = this.project(this.getCenter()), s = this.project(t), r = this.getPixelBounds(), a = D([r.min.add(i), r.max.subtract(n)]), h = a.getSize();
    if (!a.contains(s)) {
      this._enforcingBounds = !0;
  ...
  remove: function() {
    ...
    this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), C(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (j(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
    var t;
  ...
  getBoundsZoom: function(t, e, i) {
    t = Z(t), i = f(i || [0, 0]);
    var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), u = D(this.project(a, n), this.project(r, n)).getSize(), l = c.any3d ? this.options.zoomSnap : 1, d = h.x / u.x, g = h.y / u.y, N = e ? Math.max(d, g) : Math.min(d, g);
  ...
  getSize: function() {
    return (!this._size || this._sizeChanged) && (this._size = new _(
  ...
  unproject: function(t, e) {
    return e = e === void 0 ? this._zoom : e, this.options.crs.pointToLatLng(f(t), e);
  },
  ...
  _initContainer: function(t) {
    var e = this._container = Rn(t);
    if (e) {
      if (e._leaflet_id)
        throw new Error("Map container is already initialized.");
    } else throw new Error("Map container not found.");
    p(e, "scroll", this._onScroll, this), this._containerId = w(e);
  },
  _initLayout: function() {
    var t = this._container;
    this._fadeAnimated = this.options.fadeAnimation && c.any3d, m(t, "leaflet-container" + (c.touch ? " leaflet-touch" : "") + (c.retina ? " leaflet-retina" : "") + (c.ielt9 ? " leaflet-oldie" : "") + (c.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
    var e = Rt(t, "position");
    e !== "absolute" && e !== "relative" && e !== "fixed" && e !== "sticky" && (t.style.position = "relative"), this._initPanes(), this._initControlPos && this._initControlPos();
  },
  _initPanes: function() {
    var t = this._panes = {};
    this._paneRenderers = {}, this._mapPane = this.createPane("mapPane", this._container), B(this._mapPane, new _(0, 0)), this.createPane("tilePane"), this.createPane("overlayPane"), this.createPane("shadowPane"), this.createPane("markerPane"), this.createPane("tooltipPane"), this.createPane("popupPane"), this.options.markerZoomAnimation || (m(t.markerPane, "leaflet-zoom-hide"), m(t.shadowPane, "leaflet-zoom-hide"));
  },
  // private methods that modify map state
  // @section Map state change events
  _resetView: function(t, e, i) {
    B(this._mapPane, new _(0, 0));
    var n = !this._loaded;
  ...
  _onResize: function() {
    j(this._resizeRequest), this._resizeRequest = W(
      function() {
  ...
  _findEventTargets: function(t, e) {
    for (var i = [], n, o = e === "mouseout" || e === "mouseover", s = t.target || t.srcElement, r = !1; s; ) {
      ...
      if (n && n.listens(e, !0) && (o && !yi(s, t) || (i.push(n), o)) || s === this._container)
        break;
      s = s.parentNode;
    }
  ...
  _handleDOMEvent: function(t) {
    ...
    if (!(!this._loaded || e._leaflet_disable_events || t.type === "click" && this._isClickDisabled(e))) {
      var i = t.type;
      i === "mousedown" && mi(e), this._fireDOMEvent(t, i);
    }
  },
  ...
  _fireDOMEvent: function(t, e, i) {
    ...
    if (o.length) {
      ...
      for (r = 0; r < o.length; r++)
        if (o[r].fire(e, h, !0), h.originalEvent._stopped || o[r].options.bubblingMouseEvents === !1 && $e(this._mouseEvents, e) !== -1)
          return;
    }
  },
  ...
  _getMapPanePos: function() {
    return xt(this._mapPane) || new _(0, 0);
  },
  _moved: function() {
    var t = this._getMapPanePos();
  ...
  _onPanTransitionEnd: function() {
    O(this._mapPane, "leaflet-pan-anim"), this.fire("moveend");
  },
  ...
  _createAnimProxy: function() {
    ...
    this._panes.mapPane.appendChild(t), this.on("zoomanim", function(e) {
      ...
      yt(this._proxy, this.project(e.center, e.zoom), this.getZoomScale(e.zoom, 1)), n === this._proxy.style[i] && this._animatingZoom && this._onZoomTransitionEnd();
  ...
  _tryAnimatedZoom: function(t, e, i) {
    ...
    return i.animate !== !0 && !this.getSize().contains(o) ? !1 : (W(function() {
  ...
  _onZoomTransitionEnd: function() {
    this._animatingZoom && (this._mapPane && O(this._mapPane, "leaflet-zoom-anim"), this._animatingZoom = !1, this._move(this._animateToCenter, this._animateToZoom, void 0, !0), this._tempFireZoomEvent && this.fire("zoom"), delete this._tempFireZoomEvent, this.fire("move"), this._moveEnd(!0));
  }
});
function Gn(t, e) {
  return new y(t, e);
...
var jn = it.extend({
  ...
  expand: function() {
    ...
    return t < this._section.clientHeight ? (m(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : O(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
  },
  // @method collapse(): this
  // Collapse the control container if expanded.
  collapse: function() {
    return O(this._container, "leaflet-control-layers-expanded"), this;
  },
  _initLayout: function() {
    var t = "leaflet-control-layers", e = this._container = x("div", t), i = this.options.collapsed;
    e.setAttribute("aria-haspopup", !0), Gt(e), vi(e);
  ...
  _addItem: function(t) {
    ...
    t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + w(this), i), this._layerControlInputs.push(n), n.layerId = w(t.layer), p(n, "click", this._onInputClick, this);
  ...
  _expandSafely: function() {
    var t = this._section;
    this._preventClick = !0, p(t, "click", I), this.expand();
    var e = this;
    setTimeout(function() {
      T(t, "click", I), e._preventClick = !1;
    });
  }
}), xi = it.extend({
  // @section
  ...
  _createButton: function(t, e, i, n, o) {
    var s = x("a", i, n);
    return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Gt(s), p(s, "click", wt), p(s, "click", o, this), p(s, "click", this._refocusOnMap, this), s;
  },
  _updateDisabled: function() {
    var t = this._map, e = "leaflet-disabled";
    O(this._zoomInButton, e), O(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (m(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (m(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
  }
});
y.mergeOptions({
  zoomControl: !0
...
var $n = it.extend({
...
}), Kn = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', wi = it.extend({
  // @section
  ...
  onAdd: function(t) {
    t.attributionControl = this, this._container = x("div", "leaflet-control-attribution"), Gt(this._container);
...
var Ne = c.touch ? "touchstart mousedown" : "mousedown", ht = Vt.extend({
  options: {
    // @section
  ...
  enable: function() {
    this._enabled || (p(this._dragStartTarget, Ne, this._onDown, this), this._enabled = !0);
  },
  // @method disable()
  // Disables the dragging ability
  disable: function() {
    this._enabled && (ht._dragging === this && this.finishDrag(!0), T(this._dragStartTarget, Ne, this._onDown, this), this._enabled = !1, this._moved = !1);
  },
  _onDown: function(t) {
    if (this._enabled && (this._moved = !1, !di(this._element, "leaflet-zoom-anim"))) {
      if (t.touches && t.touches.length !== 1) {
        ht._dragging === this && this.finishDrag();
        return;
      }
      if (!(ht._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (ht._dragging = this, this._preventOutline && mi(this._element), _i(), Dt(), !this._moving)) {
        this.fire("down");
        var e = t.touches ? t.touches[0] : t, i = Wn(this._element);
        this._startPoint = new _(e.clientX, e.clientY), this._startPos = xt(this._element), this._parentScale = gi(i);
  ...
  _onMove: function(t) {
    if (this._enabled) {
      ...
      var e = t.touches && t.touches.length === 1 ? t.touches[0] : t, i = new _(e.clientX, e.clientY)._subtract(this._startPoint);
  ...
  finishDrag: function(t) {
    O(document.body, "leaflet-dragging"), this._lastTarget && (O(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), T(document, "mousemove touchmove", this._onMove, this), T(document, "mouseup touchend touchcancel", this._onUp, this), pi(), Wt();
...
function Yn(t, e, i) {
  var n, o = [1, 4, 2, 8], s, r, a, h, u, l, d, g;
  for (s = 0, l = t.length; s < l; s++)
    t[s]._code = gt(t[s], e);
  for (a = 0; a < 4; a++) {
    for (d = o[a], n = [], s = 0, l = t.length, r = l - 1; s < l; r = s++)
      h = t[s], u = t[r], h._code & d ? u._code & d || (g = le(u, h, d, e, i), g._code = gt(g, e), n.push(g)) : (u._code & d && (g = le(u, h, d, e, i), g._code = gt(g, e), n.push(g)), n.push(h));
    t = n;
  }
  return t;
}
function Xn(t, e) {
  ...
  var d = v([0, 0]), g = Z(t), N = g.getNorthWest().distanceTo(g.getSouthWest()) * g.getNorthEast().distanceTo(g.getNorthWest());
  N < 1700 && (d = Pi(t));
  var A = t.length, U = [];
  for (i = 0; i < A; i++) {
    var R = v(t[i]);
    U.push(e.project(v([R.lat - d.lat, R.lng - d.lng])));
  }
  for (a = h = u = 0, i = 0, n = A - 1; i < A; n = i++)
    o = U[i], s = U[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, u += (o.y + s.y) * r, a += r * 3;
  a === 0 ? l = U[0] : l = [h / a, u / a];
  var ft = e.unproject(f(l));
  return v([ft.lat + d.lat, ft.lng + d.lng]);
}
function Pi(t) {
...
function ue(t, e, i, n, o) {
  var s = 0, r, a, h;
  for (a = n + 1; a <= o - 1; a++)
    h = xe(t[a], t[n], t[o], !0), h > s && (r = a, s = h);
  s > i && (e[r] = 1, ue(t, e, i, n, r), ue(t, e, i, r, o));
}
function eo(t, e) {
  for (var i = [t[0]], n = 1, o = 0, s = t.length; n < s; n++)
    no(t[n], t[o]) > e && (i.push(t[n]), o = n);
  return o < s - 1 && i.push(t[s - 1]), i;
}
var Re;
function io(t, e, i, n, o) {
  var s = n ? Re : gt(t, i), r = gt(e, i), a, h, u;
  for (Re = r; ; ) {
    if (!(s | r))
      return [t, e];
    if (s & r)
      return !1;
    a = s || r, h = le(t, e, a, i, o), u = gt(h, i), a === s ? (t = h, s = u) : (e = h, r = u);
  }
}
function le(t, e, i, n, o) {
  var s = e.x - t.x, r = e.y - t.y, a = n.min, h = n.max, u, l;
  return i & 8 ? (u = t.x + s * (h.y - t.y) / r, l = h.y) : i & 4 ? (u = t.x + s * (a.y - t.y) / r, l = a.y) : i & 2 ? (u = h.x, l = t.y + r * (h.x - t.x) / s) : i & 1 && (u = a.x, l = t.y + r * (a.x - t.x) / s), new _(u, l, o);
}
function gt(t, e) {
  var i = 0;
...
function xe(t, e, i, n) {
  ...
  return h > 0 && (u = ((t.x - o) * r + (t.y - s) * a) / h, u > 1 ? (o = i.x, s = i.y) : u > 0 && (o += r * u, s += a * u)), r = t.x - o, a = t.y - s, n ? r * r + a * a : new _(o, s);
}
function $(t) {
...
function so(t, e) {
  ...
  if (!t || t.length === 0)
    throw new Error("latlngs not passed");
  $(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
  var l = v([0, 0]), d = Z(t), g = d.getNorthWest().distanceTo(d.getSouthWest()) * d.getNorthEast().distanceTo(d.getNorthWest());
  g < 1700 && (l = Pi(t));
  var N = t.length, A = [];
  for (i = 0; i < N; i++) {
    var U = v(t[i]);
    A.push(e.project(v([U.lat - l.lat, U.lng - l.lng])));
  }
  for (i = 0, n = 0; i < N - 1; i++)
  ...
  var R = e.unproject(f(u));
  return v([R.lat + l.lat, R.lng + l.lng]);
}
var Li = {
  project: function(t) {
  ...
  project: function(t) {
    ...
    return n = -i * Math.log(Math.max(a, 1e-10)), new _(t.lng * e * i, n);
  },
  unproject: function(t) {
...
var Bt = Q.extend({
  ...
  _setIconStyles: function(t, e) {
    ...
    var o = f(n), s = f(e === "shadow" && i.shadowAnchor || i.iconAnchor || o && o.divideBy(2, !0));
  ...
  _getIconUrl: function(t) {
    return typeof Tt.imagePath != "string" && (Tt.imagePath = this._detectIconPath()), (this.options.imagePath || Tt.imagePath) + Ct.prototype._getIconUrl.call(this, t);
  },
  ...
  _detectIconPath: function() {
    var t = x("div", "leaflet-default-icon-path", document.body), e = Rt(t, "background-image") || Rt(t, "backgroundImage");
  ...
  removeHooks: function() {
    this._draggable.off({
      ...
      drag: this._onDrag,
      dragend: this._onDragEnd
    }, this).disable(), this._marker._icon && O(this._marker._icon, "leaflet-marker-draggable");
  },
  moved: function() {
    return this._draggable && this._draggable._moved;
  },
  _adjustPan: function(t) {
    var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = xt(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = D(
    ...
    if (!h.contains(s)) {
      ...
      i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), B(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = W(this._adjustPan.bind(this, t));
    }
  },
  ...
  _onPreDrag: function(t) {
    this._marker.options.autoPan && (j(this._panRequest), this._panRequest = W(this._adjustPan.bind(this, t)));
  },
  _onDrag: function(t) {
  ...
  _initIcon: function() {
    ...
    o !== this._shadow && (this._removeShadow(), s = !0), o && (m(o, e), o.alt = ""), this._shadow = o, t.opacity < 1 && this._updateOpacity(), n && this.getPane().appendChild(this._icon), this._initInteraction(), o && s && this.getPane(t.shadowPane).appendChild(this._shadow);
  },
  _removeIcon: function() {
    this.options.riseOnHover && this.off({
      mouseover: this._bringToFront,
      mouseout: this._resetZIndex
    }), this.options.autoPanOnFocus && T(this._icon, "focus", this._panOnFocus, this), C(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
  },
  ...
  _initInteraction: function() {
    if (this.options.interactive && (m(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), We)) {
      var t = this.options.draggable;
      this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new We(this), t && this.dragging.enable();
    }
  },
  ...
  _panOnFocus: function() {
    var t = this._map;
    if (t) {
      var e = this.options.icon.options, i = e.iconSize ? f(e.iconSize) : f(0, 0), n = e.iconAnchor ? f(e.iconAnchor) : f(0, 0);
...
var ct = Q.extend({
  ...
  initialize: function(t, e) {
    k(this, e), this._latlng = v(t), this._radius = this.options.radius;
  },
  // @method setLatLng(latLng: LatLng): this
  ...
  initialize: function(t, e, i) {
    if (typeof e == "number" && (e = b({}, i, { radius: e })), k(this, e), this._latlng = v(t), isNaN(this.options.radius))
  ...
  _project: function() {
    ...
    if (n.distance === st.distance) {
      var o = Math.PI / 180, s = this._mRadius / st.R / o, r = i.project([e + s, t]), a = i.project([e - s, t]), h = r.add(a).divideBy(2), u = i.unproject(h).lat, l = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(u * o)) / (Math.cos(e * o) * Math.cos(u * o))) / o;
  ...
  closestLayerPoint: function(t) {
    for (var e = 1 / 0, i = null, n = xe, o, s, r = 0, a = this._parts.length; r < a; r++)
  ...
  _updateBounds: function() {
    var t = this._clickTolerance(), e = new _(t, t);
    ...
    if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
      ...
      for (i = 0, o = 0, s = this._rings.length; i < s; i++)
        for (h = this._rings[i], n = 0, r = h.length; n < r - 1; n++)
          a = io(h[n], h[n + 1], t, n, !0), a && (e[o] = e[o] || [], e[o].push(a[0]), (a[1] !== h[n + 1] || n === r - 2) && (e[o].push(a[1]), o++));
    }
  },
...
var Ft = ut.extend({
  ...
  _convertLatLngs: function(t) {
    var e = ut.prototype._convertLatLngs.call(this, t), i = e.length;
    return i >= 2 && e[0] instanceof P && e[0].equals(e[i - 1]) && e.pop(), e;
  },
  _setLatLngs: function(t) {
    ut.prototype._setLatLngs.call(this, t), $(this._latlngs) && (this._latlngs = [this._latlngs]);
  },
  _defaultShape: function() {
    return $(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
  },
  _clipPoints: function() {
    var t = this._renderer._bounds, e = this.options.weight, i = new _(e, e);
    if (t = new z(t.min.subtract(i), t.max.add(i)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
      ...
      for (var n = 0, o = this._rings.length, s; n < o; n++)
        s = Yn(this._rings[n], t, !0), s.length && this._parts.push(s);
    }
  },
  _updatePath: function() {
  ...
  addData: function(t) {
    ...
    if (s.filter && !s.filter(t))
      return this;
    var r = Ht(t, s);
    return r ? (r.feature = $t(t), r.defaultOptions = r.options, this.resetStyle(r), s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this;
  },
...
function Ht(t, e) {
  var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], s = e && e.pointToLayer, r = e && e.coordsToLatLng || Pe, a, h, u, l;
  if (!n && !i)
    return null;
  switch (i.type) {
    case "Point":
      return a = r(n), Fe(s, t, a, e);
    case "MultiPoint":
      for (u = 0, l = n.length; u < l; u++)
        a = r(n[u]), o.push(Fe(s, t, a, e));
      return new lt(o);
    case "LineString":
    case "MultiLineString":
      return h = Ut(n, i.type === "LineString" ? 0 : 1, r), new ut(h, e);
    case "Polygon":
    case "MultiPolygon":
...
function Fe(t, e, i, n) {
  return t ? t(e, i) : new we(i, n && n.markersInheritOptions && n);
}
function Pe(t) {
...
function Ut(t, e, i) {
  for (var n = [], o = 0, s = t.length, r; o < s; o++)
    r = e ? Ut(t[o], e - 1, i) : (i || Pe)(t[o]), n.push(r);
  return n;
}
function Le(t, e) {
  return t = v(t), t.alt !== void 0 ? [tt(t.lng, e), tt(t.lat, e), tt(t.alt, e)] : [tt(t.lng, e), tt(t.lat, e)];
}
function jt(t, e, i, n) {
  for (var o = [], s = 0, r = t.length; s < r; s++)
    o.push(e ? jt(t[s], $(t[s]) ? 0 : e - 1, i, n) : Le(t[s], n));
  return !e && i && o.length > 0 && o.push(o[0].slice()), o;
}
function Pt(t, e) {
  return t.feature ? b({}, t.feature, { geometry: e }) : $t(e);
}
function $t(t) {
...
var be = {
  toGeoJSON: function(t) {
    return Pt(this, {
      type: "Point",
      coordinates: Le(this.getLatLng(), t)
    });
  }
};
we.include(be);
...
ut.include({
  toGeoJSON: function(t) {
    var e = !$(this._latlngs), i = jt(this._latlngs, e ? 1 : 0, !1, t);
    return Pt(this, {
...
Ft.include({
  toGeoJSON: function(t) {
    var e = !$(this._latlngs), i = e && !$(this._latlngs[0]), n = jt(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
    return e || (n = [n]), Pt(this, {
...
var Mi = Q.extend({
  ...
  initialize: function(t, e, i) {
    this._url = t, this._bounds = Z(e), k(this, i);
  },
  onAdd: function() {
  ...
  _initImage: function() {
    ...
    if (m(e, "leaflet-image-layer"), this._zoomAnimated && m(e, "leaflet-zoom-animated"), this.options.className && m(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onload = M(this.fire, this, "load"), e.onerror = M(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
      this._url = e.src;
      return;
    }
...
Mi.extend({
  ...
  _initImage: function() {
    ...
    if (m(e, "leaflet-image-layer"), this._zoomAnimated && m(e, "leaflet-zoom-animated"), this.options.className && m(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onloadeddata = M(this.fire, this, "load"), t) {
...
Mi.extend({
  _initImage: function() {
    ...
    m(t, "leaflet-image-layer"), this._zoomAnimated && m(t, "leaflet-zoom-animated"), this.options.className && m(t, this.options.className), t.onselectstart = E, t.onmousemove = E;
  }
...
var et = Q.extend({
  ...
  initialize: function(t, e) {
    t && (t instanceof P || J(t)) ? (this._latlng = v(t), k(this, e)) : (k(this, t), this._source = e), this.options.content && (this._content = this.options.content);
  },
  ...
  onAdd: function(t) {
    this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && G(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), t._fadeAnimated && G(this._container, 1), this.bringToFront(), this.options.interactive && (m(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container));
  },
  onRemove: function(t) {
    t._fadeAnimated ? (G(this._container, 0), this._removeTimeout = setTimeout(M(C, void 0, this._container), 200)) : C(this._container), this.options.interactive && (O(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
  },
  ...
  _updatePosition: function() {
    if (this._map) {
      var t = this._map.latLngToLayerPoint(this._latlng), e = f(this.options.offset), i = this._getAnchor();
...
var Ci = et.extend({
  ...
  onAdd: function(t) {
    et.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof ct || this._source.on("preclick", mt));
  },
  onRemove: function(t) {
    et.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof ct || this._source.off("preclick", mt));
  },
  getEvents: function() {
  ...
  _initLayout: function() {
    ...
    if (this._contentNode = x("div", t + "-content", i), Gt(e), vi(this._contentNode), p(e, "contextmenu", mt), this._tipContainer = x("div", t + "-tip-container", e), this._tip = x("div", t + "-tip", this._tipContainer), this.options.closeButton) {
  ...
  _updateLayout: function() {
    ...
    o && n > o ? (e.height = o + "px", m(t, s)) : O(t, s), this._containerWidth = this._container.offsetWidth;
  },
  _animateZoom: function(t) {
  ...
  _adjustPan: function() {
    if (this.options.autoPan) {
      ...
      var t = this._map, e = parseInt(Rt(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new _(this._containerLeft, -i - this._containerBottom);
      o._add(xt(this._container));
      var s = t.layerPointToContainerPoint(o), r = f(this.options.autoPanPadding), a = f(this.options.autoPanPaddingTopLeft || r), h = f(this.options.autoPanPaddingBottomRight || r), u = t.getSize(), l = 0, d = 0;
      s.x + n + h.x > u.x && (l = s.x + n - u.x + h.x), s.x - l - a.x < 0 && (l = s.x - a.x), s.y + i + h.y > u.y && (d = s.y + i - u.y + h.y), s.y - d - a.y < 0 && (d = s.y - a.y), (l || d) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([l, d]));
    }
  },
  _getAnchor: function() {
...
var zi = et.extend({
  ...
  _setPosition: function(t) {
    var e, i, n = this._map, o = this._container, s = n.latLngToContainerPoint(n.getCenter()), r = n.layerPointToContainerPoint(t), a = this.options.direction, h = o.offsetWidth, u = o.offsetHeight, l = f(this.options.offset), d = this._getAnchor();
    a === "top" ? (e = h / 2, i = u) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = u / 2) : a === "right" ? (e = 0, i = u / 2) : a === "left" ? (e = h, i = u / 2) : r.x < s.x ? (a = "right", e = 0, i = u / 2) : (a = "left", e = h + (l.x + d.x) * 2, i = u / 2), t = t.subtract(f(e, i, !0)).add(l).add(d), O(o, "leaflet-tooltip-right"), O(o, "leaflet-tooltip-left"), O(o, "leaflet-tooltip-top"), O(o, "leaflet-tooltip-bottom"), m(o, "leaflet-tooltip-" + a), B(o, t);
  },
  _updatePosition: function() {
...
Q.include({
  ...
  bindTooltip: function(t, e) {
    return this._tooltip && this.isTooltipOpen() && this.unbindTooltip(), this._tooltip = this._initOverlay(zi, this._tooltip, t, e), this._initTooltipInteractions(), this._tooltip.options.permanent && this._map && this._map.hasLayer(this) && this.openTooltip(), this;
  },
...
var Qt = Q.extend({
  ...
  getEvents: function() {
    ...
    return this.options.updateWhenIdle || (this._onMove || (this._onMove = Qi(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t;
  },
  // @section Extension methods
    ...
    if (this._map && !c.ielt9) {
      ...
      for (var n in this._tiles) {
        ...
        if (!(!o.current || !o.loaded)) {
          ...
          G(o.el, s), s < 1 ? e = !0 : (o.active ? i = !0 : this._onOpaqueTile(o), o.active = !0);
        }
      }
      i && !this._noPrune && this._pruneTiles(), e && (j(this._fadeFrame), this._fadeFrame = W(this._updateOpacity, this));
    }
  },
  _onOpaqueTile: E,
  ...
  _retainParent: function(t, e, i, n) {
    var o = Math.floor(t / 2), s = Math.floor(e / 2), r = i - 1, a = new _(+o, +s);
    a.z = +r;
    ...
    if (e) {
      ...
      if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
        ...
        for (var u in this._tiles) {
          ...
          (l.z !== this._tileZoom || !h.contains(new _(l.x, l.y))) && (this._tiles[u].current = !1);
        }
        ...
        if (r.sort(function(R, ft) {
          return R.distanceTo(s) - ft.distanceTo(s);
        }), r.length !== 0) {
  ...
  _initTile: function(t) {
    ...
    t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = E, t.onmousemove = E, c.ielt9 && this.options.opacity < 1 && G(t, this.options.opacity);
  },
  _addTile: function(t, e) {
    var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), M(this._tileReady, this, t));
    this._initTile(o), this.createTile.length < 2 && W(M(this._tileReady, this, t, null, o)), B(o, i), this._tiles[n] = {
      el: o,
      coords: t,
      current: !0
  ...
  _tileReady: function(t, e, i) {
    ...
    i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (G(i.el, 0), j(this._fadeFrame), this._fadeFrame = W(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (m(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
      tile: i.el,
      coords: t
    })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), c.ielt9 || !this._map._fadeAnimated ? W(this._pruneTiles, this) : setTimeout(M(this._pruneTiles, this), 250)));
  },
  ...
  createTile: function(t, e) {
    ...
    return p(i, "load", M(this._tileOnLoad, this, e, i)), p(i, "error", M(this._tileOnError, this, e, i)), (this.options.crossOrigin || this.options.crossOrigin === "") && (i.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), typeof this.options.referrerPolicy == "string" && (i.referrerPolicy = this.options.referrerPolicy), i.alt = "", i.src = this.getTileUrl(t), i;
  },
  // @section Extension methods
  // @uninheritable
  ...
  _removeTile: function(t) {
    var e = this._tiles[t];
    if (e)
      return e.el.setAttribute("src", Xt), Qt.prototype._removeTile.call(this, t);
  },
  _tileReady: function(t, e, i) {
...
var Si = Mt.extend({
  ...
  getTileUrl: function(t) {
    var e = this._tileCoordsToNwSe(t), i = this._crs, n = D(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === bi ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = Mt.prototype.getTileUrl.call(this, t);
    return a + tn(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r;
  },
...
var ot = Q.extend({
  ...
  initialize: function(t) {
    k(this, t), w(this), this._layers = this._layers || {};
  },
  onAdd: function() {
  ...
  _updateTransform: function(t, e) {
    ...
    c.any3d ? yt(this._container, s, i) : B(this._container, s);
  },
  _reset: function() {
  ...
  _destroyContainer: function() {
    j(this._redrawRequest), delete this._ctx, C(this._container), T(this._container), delete this._container;
  },
  _updatePaths: function() {
  ...
  _update: function() {
    if (!(this._map._animatingZoom && this._bounds)) {
      ...
      B(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", c.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update");
    }
  },
  _reset: function() {
  ...
  _handleMouseOut: function(t) {
    ...
    e && (O(this._container, "leaflet-interactive"), this._fireEvent([e], t, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = !1);
  },
  _handleMouseHover: function(t, e) {
    if (!this._mouseHoverThrottled) {
      for (var i, n, o = this._drawFirst; o; o = o.next)
        i = o.layer, i.options.interactive && i._containsPoint(e) && (n = i);
      n !== this._hoveredLayer && (this._handleMouseOut(t), n && (m(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : !1, t), this._mouseHoverThrottled = !0, setTimeout(M(function() {
...
var bt = function() {
  ...
  _initPath: function(t) {
    var e = t._container = bt("shape");
    m(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = bt("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[w(t)] = t;
  },
  _addPath: function(t) {
    var e = t._container;
  ...
  _updateStyle: function(t) {
    ...
    o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (e || (e = t._stroke = bt("stroke")), o.appendChild(e), e.weight = n.weight + "px", e.color = n.color, e.opacity = n.opacity, n.dashArray ? e.dashStyle = J(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : e.dashStyle = "", e.endcap = n.lineCap.replace("butt", "flat"), e.joinstyle = n.lineJoin) : e && (o.removeChild(e), t._stroke = null), n.fill ? (i || (i = t._fill = bt("fill")), o.appendChild(i), i.color = n.fillColor || n.color, i.opacity = n.fillOpacity) : i && (o.removeChild(i), t._fill = null);
  },
  _updateCircle: function(t) {
...
}, At = c.vml ? bt : Xe, Kt = ot.extend({
  _initContainer: function() {
    this._container = At("svg"), this._container.setAttribute("pointer-events", "none"), this._rootGroup = At("g"), this._container.appendChild(this._rootGroup);
  },
  _destroyContainer: function() {
    C(this._container), T(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
  },
  _update: function() {
    if (!(this._map._animatingZoom && this._bounds)) {
      ot.prototype._update.call(this);
  ...
  _initPath: function(t) {
    var e = t._path = At("path");
    t.options.className && m(e, t.options.className), t.options.interactive && m(e, "leaflet-interactive"), this._updateStyle(t), this._layers[w(t)] = t;
  },
  _addPath: function(t) {
...
c.vml && Kt.include(_o);
function po(t) {
  return c.svg || c.vml ? new Kt(t) : null;
}
y.include({
  ...
  _createRenderer: function(t) {
    return this.options.preferCanvas && fo(t) || po(t);
  }
});
Ft.extend({
  initialize: function(t, e) {
...
Kt.create = At;
Kt.pointsToPath = Je;
dt.geometryToLayer = Ht;
dt.coordsToLatLng = Pe;
dt.coordsToLatLngs = Ut;
dt.latLngToCoords = Le;
dt.latLngsToCoords = jt;
dt.getFeature = Pt;
dt.asFeature = $t;
y.mergeOptions({
...
var Ei = nt.extend({
  ...
  _onMouseDown: function(t) {
    if (!t.shiftKey || t.which !== 1 && t.button !== 1)
      return !1;
    this._clearDeferredResetState(), this._resetState(), Dt(), _i(), this._startPoint = this._map.mouseEventToContainerPoint(t), p(document, {
      contextmenu: wt,
  ...
  _onMouseMove: function(t) {
    this._moved || (this._moved = !0, this._box = x("div", "leaflet-zoom-box", this._container), m(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
  ...
  _finish: function() {
    this._moved && (C(this._box), O(this._container, "leaflet-crosshair")), Wt(), pi(), T(document, {
      contextmenu: wt,
      mousemove: this._onMouseMove,
      mouseup: this._onMouseUp,
      keydown: this._onKeyDown
...
y.addInitHook("addHandler", "boxZoom", Ei);
y.mergeOptions({
...
y.addInitHook("addHandler", "doubleClickZoom", Zi);
y.mergeOptions({
...
var Oi = nt.extend({
  ...
  removeHooks: function() {
    O(this._map._container, "leaflet-grab"), O(this._map._container, "leaflet-touch-drag"), this._draggable.disable();
  },
  moved: function() {
    return this._draggable && this._draggable._moved;
  },
  ...
  _onDragEnd: function(t) {
    ...
    if (e.fire("dragend", t), n)
      ...
      var o = this._lastPos.subtract(this._positions[0]), s = (this._lastTime - this._times[0]) / 1e3, r = i.easeLinearity, a = o.multiplyBy(r / s), h = a.distanceTo([0, 0]), u = Math.min(i.inertiaMaxSpeed, h), l = a.multiplyBy(u / h), d = u / (i.inertiaDeceleration * r), g = l.multiplyBy(-d / 2).round();
      !g.x && !g.y ? e.fire("moveend") : (g = e._limitOffset(g, e.options.maxBounds), W(function() {
        e.panBy(g, {
          duration: d,
          easeLinearity: r,
          noMoveStart: !0,
...
var Bi = nt.extend({
  ...
  removeHooks: function() {
    this._removeHooks(), T(this._map._container, {
      focus: this._onFocus,
      blur: this._onBlur,
      mousedown: this._onMouseDown
    }, this), this._map.off({
    ...
    if (!(t.altKey || t.ctrlKey || t.metaKey)) {
      ...
      if (e in this._panKeys) {
        if (!i._panAnim || !i._panAnim._inProgress)
          if (n = this._panKeys[e], t.shiftKey && (n = f(n).multiplyBy(3)), i.options.maxBounds && (n = i._limitOffset(f(n), i.options.maxBounds)), i.options.worldCopyJump) {
...
y.addInitHook("addHandler", "keyboard", Bi);
y.mergeOptions({
...
var Ai = nt.extend({
  ...
  _onWheelScroll: function(t) {
    var e = Vn(t), i = this._map.options.wheelDebounceTime;
    this._delta += e, this._lastMousePos = this._map.mouseEventToContainerPoint(t), this._startTime || (this._startTime = +/* @__PURE__ */ new Date());
    var n = Math.max(i - (+/* @__PURE__ */ new Date() - this._startTime), 0);
    clearTimeout(this._timer), this._timer = setTimeout(M(this._performZoom, this), n), wt(t);
  },
...
var Ii = nt.extend({
  ...
  _onDown: function(t) {
    if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
      var e = t.touches[0];
      this._startPos = this._newPos = new _(e.clientX, e.clientY), this._holdTimeout = setTimeout(M(function() {
        this._cancel(), this._isTapValid() && (p(document, "touchend", I), p(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
      }, this), mo), p(document, "touchend touchcancel contextmenu", this._cancel, this), p(document, "touchmove", this._onMove, this);
    }
  },
  _cancelClickPrevent: function t() {
    T(document, "touchend", I), T(document, "touchend touchcancel", t);
  },
  _cancel: function() {
    clearTimeout(this._holdTimeout), T(document, "touchend touchcancel contextmenu", this._cancel, this), T(document, "touchmove", this._onMove, this);
  },
  _onMove: function(t) {
    var e = t.touches[0];
    this._newPos = new _(e.clientX, e.clientY);
  },
...
y.addInitHook("addHandler", "tapHold", Ii);
y.mergeOptions({
  // @section Touch interaction options
...
var Ni = nt.extend({
  addHooks: function() {
    m(this._map._container, "leaflet-touch-zoom"), p(this._map._container, "touchstart", this._onTouchStart, this);
  },
  removeHooks: function() {
    O(this._map._container, "leaflet-touch-zoom"), T(this._map._container, "touchstart", this._onTouchStart, this);
  },
  _onTouchStart: function(t) {
    var e = this._map;
    if (!(!t.touches || t.touches.length !== 2 || e._animatingZoom || this._zooming)) {
      var i = e.mouseEventToContainerPoint(t.touches[0]), n = e.mouseEventToContainerPoint(t.touches[1]);
      this._centerPoint = e.getSize()._divideBy(2), this._startLatLng = e.containerPointToLatLng(this._centerPoint), e.options.touchZoom !== "center" && (this._pinchStartLatLng = e.containerPointToLatLng(i.add(n)._divideBy(2))), this._startDist = i.distanceTo(n), this._startZoom = e.getZoom(), this._moved = !1, this._zooming = !0, e._stop(), p(document, "touchmove", this._onTouchMove, this), p(document, "touchend touchcancel", this._onTouchEnd, this), I(t);
    }
  },
  _onTouchMove: function(t) {
    if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
      ...
      this._animRequest = W(r, this, !0), I(t);
    }
  },
...
y.BoxZoom = Ei;
y.DoubleClickZoom = Zi;
y.Drag = Oi;
y.Keyboard = Bi;
y.ScrollWheelZoom = Ai;
y.TapHold = Ii;
y.TouchZoom = Ni;
var go = Object.getOwnPropertyDescriptor, vo = (t, e, i, n) => {
  for (var o = n > 1 ? void 0 : n ? go(e, i) : e, s = t.length - 1, r; s >= 0; s--)
    (r = t[s]) && (o = r(o) || o);
  return o;
};
const He = { southWestCorner: { latitude: 54.970495, longitude: -1.627864 }, northEastCorner: { latitude: 54.97911, longitude: -1.609625 } }, Ue = "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", yo = new Ct({
  iconUrl: "/App_Plugins/Protenacity.OpenStreetMap/marker-icon.png",
  shadowUrl: "/App_Plugins/Protenacity.OpenStreetMap/marker-shadow.png",
  iconSize: [25, 41],
  iconAnchor: [12, 41],
  popupAnchor: [1, -34],
  shadowSize: [41, 41]
...
let ce = class extends fe {
  constructor() {
    super(...arguments), this.scrollWheelZoom = !1, this._boundingBox = He, this._zoom = 16, this.tileLayerPath = Ue, this.tileLayerOptions = { attribution: "Map data © OpenStreetMap contributors" };
  }
  set boundingBox(t) {
    !t || t === this._boundingBox || (this._boundingBox = t, this._map && this.fitBounds(t));
  }
  get boundingBox() {
    return this._boundingBox || He;
  }
  set markerLocation(t) {
    !t || t === this._markerLocation || (this._markerLocation = t, this._map && this.updateMarker(t));
  }
  get markerLocation() {
    return this._markerLocation;
  }
  set zoom(t) {
    this._map && t != this._zoom && this.setZoom(t);
  }
  get zoom() {
  ...
  async firstUpdated(t) {
    ...
    const e = this.renderRoot.querySelector(".map");
    if (!e) {
      console.warn("no DOM element found. Bailing!");
      return;
    }
    this._map = Gn(e, { scrollWheelZoom: this.scrollWheelZoom }), this.fitBounds(this.boundingBox), this.tileLayer(this.tileLayerPath, this.tileLayerOptions), this._map.on("click", this.onMapClick.bind(this)), this._map.on("moveend", this.onMoveEnd.bind(this)), this._map.on("zoomend", this.onZoomEnd.bind(this)), this._map.on("contextmenu", () => {
    }), this.updateMarker(this.markerLocation, !0);
  }
  fitBounds(t) {
    return this._boundingBox = t, this._map.fitBounds(
      Z(
        v(t.southWestCorner.latitude, t.southWestCorner.longitude),
        v(t.northEastCorner.latitude, t.northEastCorner.longitude)
      )
    );
  }
  tileLayer(t, e) {
    return ki(t || Ue, e).addTo(this._map);
  }
  clearMarker() {
    var t;
    (t = this._marker) == null || t.remove(), this._marker = void 0;
  }
  updateMarker(t, e) {
    var i;
    this._marker && this.clearMarker(), t && (this._marker = ho(v(t.latitude, t.longitude), { draggable: !0, icon: yo }).addTo(this._map), this._markerLocation = t), e || (this._map.setView(v(t.latitude, t.longitude)), this.updateModel()), (i = this._marker) == null || i.on("dragend", () => {
      this._markerLocation = { latitude: this._marker.getLatLng().lat, longitude: this._marker.getLatLng().lng }, this.updateModel();
    });
  }
  setZoom(t) {
    this._map.setZoom(t);
  ...
  updateModel() {
    this.dispatchEvent(new CustomEvent("mapdata-changed", { bubbles: !0 }));
  }
  onMapClick(t) {
    this.updateMarker({ latitude: t.latlng.lat, longitude: t.latlng.lng });
  }
  onMoveEnd() {
    this._boundingBox = {
      northEastCorner: {
  ...
  onZoomEnd() {
    this._zoom = this._map.getZoom(), this.onMoveEnd();
  }
  render() {
    return _t`<link rel="stylesheet" href="https://unpkg.com/leaflet@${Xi}/dist/leaflet.css" /><div class="map"></div>`;
  }
};
ce.styles = [Ve`
    :host {
  ...
  `];
ce = vo([
  de("posm-openstreetmap")
], ce);
var xo = Object.defineProperty, wo = Object.getOwnPropertyDescriptor, q = (t, e, i, n) => {
  for (var o = n > 1 ? void 0 : n ? wo(e, i) : e, s = t.length - 1, r; s >= 0; s--)
    (r = t[s]) && (o = (n ? r(e, i, o) : r(o)) || o);
  return n && o && xo(e, i, o), o;
};
let H = class extends Gi(fe) {
  constructor() {
    super(...arguments), this.value = {}, this._showSearch = !1, this._showSetMarkerByCoordinates = !1, this._showCoordinates = !1, this._allowClear = !1, this._scrollWheelZoom = !1, this._tileLayer = "", this._tileLayerAttribution = "", this.searchLabel = "Type to search";
  }
  set config(t) {
    this._showSearch = (t == null ? void 0 : t.getValueByAlias("showSearch")) ?? !1, this._showSetMarkerByCoordinates = (t == null ? void 0 : t.getValueByAlias("showSetMarkerByCoordinates")) ?? !1, this._showCoordinates = (t == null ? void 0 : t.getValueByAlias("showCoordinates")) ?? !1, this._allowClear = (t == null ? void 0 : t.getValueByAlias("allowClear")) ?? !1, this._scrollWheelZoom = (t == null ? void 0 : t.getValueByAlias("scrollWheelZoom")) ?? !1, this._tileLayer = (t == null ? void 0 : t.getValueByAlias("tileLayer")) ?? "", this._tileLayerAttribution = (t == null ? void 0 : t.getValueByAlias("tileLayerAttribution")) ?? "", this._defaultPosition = t == null ? void 0 : t.getValueByAlias("defaultPosition");
  }
  async firstUpdated(t) {
    var e, i, n;
    super.firstUpdated(t), (e = this.value) != null && e.marker && (this.inputLat = (i = this.value.marker) == null ? void 0 : i.latitude.toFixed(4), this.inputLng = (n = this.value.marker) == null ? void 0 : n.longitude.toFixed(4));
  }
  searchSelected(t) {
    ...
    this.value = {
      ...this.value,
      marker: {
        latitude: e.value.marker[1],
        longitude: e.value.marker[0]
      },
      boundingBox: {
        southWestCorner: {
          latitude: e.value.bbox[1],
          longitude: e.value.bbox[0]
        },
        northEastCorner: {
          latitude: e.value.bbox[3],
          longitude: e.value.bbox[2]
        }
      }
    };
  }
  setMarker() {
    ...
    this.value = {
      ...this.value,
      marker: {
        latitude: parseFloat(((t = this.shadowRoot) == null ? void 0 : t.getElementById("inputLat")).value),
        longitude: parseFloat(((e = this.shadowRoot) == null ? void 0 : e.getElementById("inputLng")).value)
      }
    };
  }
  clearMarker() {
  ...
  connectedCallback() {
    super.connectedCallback(), this.searchLabel = this.localize.term("osm_searchPlaceholder");
  }
  updateData(t) {
    var i, n, o;
    const e = t.target;
    this.value = {
      ...
      zoom: e.zoom,
      marker: e.markerLocation
    }, (i = this.value) != null && i.marker && (this.inputLat = (n = this.value.marker) == null ? void 0 : n.latitude.toFixed(4), this.inputLng = (o = this.value.marker) == null ? void 0 : o.longitude.toFixed(4)), this.dispatchEvent(new CustomEvent("property-value-change"));
  }
  async getSuggestion(t) {
    const i = await this.getUserLanguage(), n = `https://nominatim.openstreetmap.org/search?format=geojson&limit=5&q=${encodeURI(t)}&accept-language=${i}`;
    return fetch(n).then((o) => o.json()).then((o) => o.features.map((s) => ({
      name: s.properties.display_name,
      value: {
        marker: s.geometry.coordinates,
        bbox: s.bbox
      }
    })));
  }
  async getUserLanguage() {
    return new Promise((t) => {
      this.getContext(ji).then((e) => {
        this.observe(e.currentUser, (i) => {
          t(i == null ? void 0 : i.languageIsoCode);
        });
      });
    });
  }
  render() {
    var t, e, i, n, o, s, r, a, h, u;
    return _t`
            ${this._showSearch ? _t`
                        <posm-openstreetmap-auto-suggest 
                            id="searchField" 
            ...
            ${this._showSetMarkerByCoordinates ? _t`
            ...
            <posm-openstreetmap
                .zoom=${(t = this.value) != null && t.zoom ? this.value.zoom : (e = this._defaultPosition) == null ? void 0 : e.zoom}
                .markerLocation=${(i = this.value) != null && i.marker ? this.value.marker : (n = this._defaultPosition) == null ? void 0 : n.marker}
                .boundingBox=${(o = this.value) != null && o.boundingBox ? this.value.boundingBox : (s = this._defaultPosition) == null ? void 0 : s.boundingBox}
            ...
            ${(this._showCoordinates || this._allowClear) && ((r = this.value) != null && r.marker) ? _t`
                        <div style="clear:both;">
                            <umb-localize key="osm_latitude"></umb-localize>: ${(a = this.value.marker) == null ? void 0 : a.latitude.toFixed(4)}, 
                            <umb-localize key="osm_longitude"></umb-localize>: ${(h = this.value.marker) == null ? void 0 : h.longitude.toFixed(4)}
                            <uui-button @click=${this.clearMarker} .disabled=${!((u = this.value) != null && u.marker)} look="outline" style="float:right;"><umb-localize key="osm_clear"></umb-localize></uui-button>
                        </div>
                    ` : ""}
...
q([
  X()
], H.prototype, "_showSearch", 2);
q([
  X()
], H.prototype, "_showSetMarkerByCoordinates", 2);
q([
  X()
], H.prototype, "_showCoordinates", 2);
q([
  X()
], H.prototype, "_allowClear", 2);
q([
  X()
], H.prototype, "_scrollWheelZoom", 2);
q([
  X()
], H.prototype, "_tileLayer", 2);
q([
  X()
], H.prototype, "_tileLayerAttribution", 2);
q([
  X()
], H.prototype, "_defaultPosition", 2);
q([
  X()
], H.prototype, "inputLat", 2);
q([
  X()
], H.prototype, "inputLng", 2);
H = q([
  de("posm-openstreetmap-property-editor")
], H);
export {
  ce as PosmOpenStreetMapElement,
  H as default
};
//# sourceMappingURL=protenacity-openstreetmap.js.map
