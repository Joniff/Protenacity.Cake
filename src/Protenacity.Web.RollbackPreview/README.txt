...
* The build output is copied to `wwwroot\App_Plugins\Protenacity.Rollback\protenacity-rollback.js`
...
As of now, 13 August 2025, There isn't an Umbraco version 16 of https://github.com/Rockerby/Umbraco.Community.RollbackPreviewer
There was a branch called v16 (https://github.com/Rockerby/Umbraco.Community.RollbackPreviewer/tree/dev/v16) but this hasn't be published to nuget yet.
This code is a slight tidied up version of that v16 branch

If a nuget version for Umbraco 16 is released, suggest dropping this project and use that nuget instead
