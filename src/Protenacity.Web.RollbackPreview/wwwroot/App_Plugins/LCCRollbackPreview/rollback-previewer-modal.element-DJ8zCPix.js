...
class qe {
  ...
  setPreventCleanup(t, i) {
    return S(f(this, _), D.putDocumentVersionByIdPreventCleanup({ path: { id: t }, query: { preventCleanup: i } }));
  }
  rollback(t, i) {
    return S(f(this, _), D.postDocumentVersionByIdRollback({ path: { id: t }, query: { culture: i } }));
  }
}
_ = new WeakMap();
var y;
...
//# sourceMappingURL=rollback-previewer-modal.element-DJ8zCPix.js.map
