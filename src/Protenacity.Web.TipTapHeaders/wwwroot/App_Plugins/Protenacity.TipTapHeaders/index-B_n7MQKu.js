  ...
  */
  findIndex(e, t = -1) {
    ...
    for (let n = 0, i = 0; ; n++) {
      ...
      if (o >= e)
        return o == e || t > 0 ? de(n + 1, o) : de(n, i);
      i = o;
    }
  }
  /**
...
y.empty = new y([], 0);
const ze = { index: 0, offset: 0 };
function de(r, e) {
  return ze.index = r, ze.offset = e, ze;
}
function Se(r, e) {
  if (r === e)
    return !0;
...
class x {
  ...
  */
  insertAt(e, t) {
    let n = It(this.content, e + this.openStart, t);
  ...
  */
  removeBetween(e, t) {
    return new x(Ot(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Tt(r, e, t, n) {
  ...
  if (i == e.index(n) && n < r.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && r.depth == n && e.depth == n) {
      ...
      return Q(s, Nt(r, o, l, e, n));
    }
  else return Q(s, ve(r, e, n));
}
function At(r, e) {
...
function Nt(r, e, t, n, i) {
  let s = r.depth > i && We(r, e, i + 1), o = n.depth > i && We(t, n, i + 1), l = [];
  return le(null, r, i, l), s && o && e.index(i) == t.index(i) ? (At(s, o), G(Q(s, Nt(r, e, t, n, i + 1)), l)) : (s && G(Q(s, ve(r, e, i + 1)), l), le(e, t, i, l), o && G(Q(o, ve(t, n, i + 1)), l)), le(n, null, i, l), new y(l);
}
function ve(r, e, t) {
  let n = [];
  if (le(null, r, t, n), r.depth > t) {
    let i = We(r, e, t + 1);
    G(Q(i, ve(r, e, t + 1)), n);
  }
  return le(e, null, t, n), new y(n);
}
function wn(r, e) {
  ...
  */
  static resolveCached(e, t) {
    ...
    if (n)
      ...
      st.set(e, n = new Sn());
    let i = n.elts[n.i] = ce.resolve(e, t);
    return n.i = (n.i + 1) % bn, i;
  }
}
class Sn {
  constructor() {
...
const bn = 12, st = /* @__PURE__ */ new WeakMap();
class Ce {
  /**
...
class $ {
  ...
  */
  hasMarkup(e, t, n) {
    return this.type == e && Se(this.attrs, t || e.defaultAttrs || vn) && v.sameSet(this.marks, n || v.none);
  }
  /**
  ...
  */
  replace(e, t, n) {
    return kn(this.resolve(e), this.resolve(t), n);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), Rt(this.marks, e);
  }
  /**
...
class Me extends $ {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : Rt(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
  ...
  mark(e) {
    return e == this.marks ? this : new Me(this.type, this.attrs, this.text, e);
  }
  withText(e) {
    return e == this.text ? this : new Me(this.type, this.attrs, e, this.marks);
  }
...
function Tn(r) {
  if (r.eat("(")) {
    ...
    let e = In(r, r.next).map((t) => (r.inline == null ? r.inline = t.isInline : r.inline != t.isInline && r.err("Mixing inline and block content"), { type: "name", value: t }));
...
class Ee {
  ...
  */
  constructor(e, t, n) {
    this.name = e, this.schema = t, this.spec = n, this.markSet = null, this.groups = n.group ? n.group.split(" ") : [], this.attrs = $t(e, n.attrs), this.defaultAttrs = Ft(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(n.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : Pt(this.attrs, e);
  }
  /**
  ...
  */
  create(e = null, t, n) {
    ...
    return new $(this, this.computeAttrs(e), y.from(t), v.setFrom(n));
  }
  /**
  ...
  */
  createChecked(e = null, t, n) {
    return t = y.from(t), this.checkContent(t), new $(this, this.computeAttrs(e), t, v.setFrom(n));
  }
  /**
  ...
  */
  checkAttrs(e) {
    Jt(this.attrs, e, "node", this.name);
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((s, o) => n[s] = new Ee(s, t, o));
...
class Bn {
  constructor(e, t, n) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default"), this.default = n.default, this.validate = typeof n.validate == "string" ? zn(e, t, n.validate) : n.validate;
  }
  get isRequired() {
...
class He {
  ...
  */
  constructor(e, t, n, i) {
    this.name = e, this.rank = t, this.schema = n, this.spec = i, this.attrs = $t(e, i.attrs), this.excluded = null;
    let s = Ft(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new v(this, Pt(this.attrs, e));
  }
  /**
  @internal
  */
  static compile(e, t) {
    ...
    return e.forEach((s, o) => n[s] = new He(s, i++, t, o)), n;
  }
  /**
  ...
  */
  checkAttrs(e) {
    Jt(this.attrs, e, "mark", this.name);
  }
  /**
...
class Fn {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = M.from(e.nodes), t.marks = M.from(e.marks || {}), this.nodes = Ee.compile(this.spec.nodes, this), this.marks = He.compile(this.spec.marks, this);
    let n = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new Me(n, n.defaultAttrs, e, v.setFrom(t));
  }
  /**
...
class ne {
  ...
  */
  parseSlice(e, t = {}) {
    ...
    return n.addAll(e, v.none, t.from, t.to), x.maxOpen(n.finish());
  }
  /**
  @internal
  */
  matchTag(e, t, n) {
    for (let i = n ? this.tags.indexOf(n) + 1 : 0; i < this.tags.length; i++) {
      let s = this.tags[i];
      if (Ln(e, s.tag) && (s.namespace === void 0 || e.namespaceURI == s.namespace) && (!s.context || t.matchesContext(s.context))) {
        if (s.getAttrs) {
          let o = s.getAttrs(e);
          if (o === !1)
            continue;
  ...
  */
  static fromSchema(e) {
    return e.cached.domParser || (e.cached.domParser = new ne(e, ne.schemaRules(e)));
  }
}
const Dt = {
  address: !0,
  ...
  style: !0,
  title: !0
}, Lt = { ol: !0, ul: !0 }, fe = 1, Ve = 2, xe = 4;
function ct(r, e, t) {
  return e != null ? (e ? fe : 0) | (e === "full" ? Ve : 0) : r && r.whitespace == "pre" ? fe | Ve : t & -5;
}
class pe {
  constructor(e, t, n, i, s, o) {
    this.type = e, this.attrs = t, this.marks = n, this.solid = i, this.options = o, this.content = [], this.activeMarks = v.none, this.match = s || (o & xe ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type)
...
class ft {
  constructor(e, t, n) {
    ...
    let i = t.topNode, s, o = ct(null, t.preserveWhitespace, 0) | (n ? xe : 0);
    i ? s = new pe(i.type, i.attrs, v.none, !0, t.topMatch || i.type.contentMatch, o) : n ? s = new pe(null, null, v.none, !0, null, o) : s = new pe(e.schema.topNodeType, null, v.none, !0, null, o), this.nodes = [s], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
  ...
  addTextNode(e, t) {
    let n = e.nodeValue, i = this.top, s = i.options & Ve ? "full" : this.localPreserveWS || (i.options & fe) > 0;
...
`);
  ...
  addElement(e, t, n) {
    ...
    Lt.hasOwnProperty(o) && this.parser.normalizeLists && Dn(e);
...
`), t);
  ...
  enterInner(e, t, n, i = !1, s) {
    ...
    let a = v.none;
    return n = n.filter((c) => (o.type ? o.type.allowsMarkType(c.type) : ht(c.type, e)) ? (a = c.addToSet(a), !1) : !0), this.nodes.push(new pe(e, t, a, i, null, l)), this.open++, n;
  }
  ...
  sync(e) {
    for (let t = this.open; t >= 0; t--) {
      ...
      this.localPreserveWS && (this.nodes[t].options |= fe);
    }
    return !1;
  }
  get currentPos() {
...
function Dn(r) {
  for (let e = r.firstChild, t = null; e; e = e.nextSibling) {
    ...
    n && Lt.hasOwnProperty(n) && t ? (t.appendChild(e), e = t) : n == "li" ? t = e : n && (t = null);
  }
}
function Ln(r, e) {
...
class pt {
  ...
  */
  get deletedBefore() {
    return (this.delInfo & (Vt | ke)) > 0;
  }
  /**
  True when the token after the mapped position was deleted.
  */
  get deletedAfter() {
    return (this.delInfo & (qt | ke)) > 0;
  }
  /**
  ...
  _map(e, t, n) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (n)
          return h;
        let m = e == (t < 0 ? a : u) ? null : jn(l / 3, e - a), p = e == a ? qt : e == u ? Vt : ke;
        return (t < 0 ? e != a : e != u) && (p |= Ht), new pt(h, p, m);
      }
      i += f - c;
    }
...
function Ke(r, e, t) {
  ...
  for (let i = 0; i < r.childCount; i++) {
    let s = r.child(i);
    s.content.size && (s = s.copy(Ke(s.content, e, s))), s.isInline && (s = e(s, t, i)), n.push(s);
  }
...
class q extends O {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), n = e.resolve(this.from), i = n.node(n.sharedDepth(this.to)), s = new x(Ke(t.content, (o, l) => !o.isAtom || !l.type.allowsMarkType(this.mark.type) ? o : o.mark(this.mark.addToSet(o.marks)), i), t.openStart, t.openEnd);
...
class H extends O {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), n = new x(Ke(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class K extends O {
  ...
  */
  ...
  apply(e) {
    ...
    return C.fromReplace(e, this.pos, this.pos + 1, new x(y.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
...
class N extends O {
  ...
  */
  ...
  apply(e) {
    return this.structure && qe(e, this.from, this.to) ? C.fail("Structure replace would overwrite content") : C.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
class A extends O {
  ...
  */
  ...
  apply(e) {
    if (this.structure && (qe(e, this.from, this.gapFrom) || qe(e, this.gapTo, this.to)))
...
function ie(r) {
  ...
  for (let n = r.depth; ; --n) {
    ...
    if (n < r.depth && i.canReplace(s, o, t))
      return n;
    if (n == 0 || i.type.spec.isolating || !Vn(i, s, o))
      break;
  }
  return null;
}
function Kt(r, e, t = null, n = r) {
  let i = qn(r, e), s = i && Hn(n, e);
...
function j(r, e, t = 1, n) {
  ...
  for (let c = i.depth - 1, f = t - 2; c > s; c--, f--) {
    ...
    if (u.type.spec.isolating)
      return !1;
    let h = u.content.cutByIndex(d, u.childCount), m = n && n[f + 1];
...
function Y(r, e) {
  ...
  return Ut(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(n, n + 1);
}
function Kn(r, e) {
...
function Ut(r, e) {
  return !!(r && e && !r.isLeaf && Kn(r, e));
}
function Ne(r, e, t = -1) {
  let n = r.resolve(e);
  for (let i = n.depth; ; i--) {
    let s, o, l = n.index(i);
    if (i == n.depth ? (s = n.nodeBefore, o = n.nodeAfter) : t > 0 ? (s = n.node(i + 1), l++, o = n.node(i).maybeChild(l)) : (s = n.node(i).maybeChild(l - 1), o = n.node(i + 1)), s && !s.isTextblock && Ut(s, o) && n.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function Ue(r, e, t = e, n = x.empty) {
  if (e == t && !n.size)
    return null;
  let i = r.resolve(e), s = r.resolve(t);
  return Un(i, s, n) ? new N(e, t, n) : new Gn(i, s, n).fit();
}
function Un(r, e, t) {
...
class Gn {
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let i, s = null;
        n ? (s = Fe(this.unplaced.content, n - 1).firstChild, i = s.content) : i = this.unplaced.content;
        let o = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced, i = Fe(e, t);
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new x(se(e, t - 1, 1), t - 1, s ? t - 1 : n);
    } else
      this.unplaced = new x(se(e, t, 1), t, n);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: i, wrap: s }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || p.content.size) && (u = g, f.push(Gt(p.mark(d.allowedMarks(p.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let m = c == l.childCount;
    m || (h = -1), this.placed = oe(this.placed, t, y.from(f)), this.frontier[t].match = u, m && h < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
    for (let p = 0, g = l; p < h; p++) {
      let k = g.lastChild;
      this.frontier.push({ type: k.type, match: k.contentMatchAt(k.childCount) }), g = k.content;
    }
    this.unplaced = m ? e == 0 ? x.empty : new x(se(o.content, e - 1, 1), e - 1, h < 0 ? o.openEnd : e - 1) : new x(se(o.content, e, c), o.openStart, o.openEnd);
  }
  mustMoveInline() {
    if (!this.$to.parent.isTextblock)
      return -1;
    let e = this.frontier[this.depth], t;
    if (!e.type.isTextblock || !Pe(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: n, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = Pe(e, t, i, n, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], f = Pe(e, l, c, a, !0);
          if (!f || f.childCount)
            continue e;
        }
  ...
  close(e) {
    ...
    for (; this.depth > t.depth; )
      this.closeFrontierNode();
    t.fit.childCount && (this.placed = oe(this.placed, t.depth, t.fit)), e = t.move;
  ...
  openFrontierNode(e, t = null, n) {
    ...
    i.match = i.match.matchType(e), this.placed = oe(this.placed, this.depth, y.from(e.create(t, n))), this.frontier.push({ type: e, match: e.contentMatch });
  }
  closeFrontierNode() {
    let t = this.frontier.pop().match.fillBefore(y.empty, !0);
    t.childCount && (this.placed = oe(this.placed, this.frontier.length, t));
  }
}
function se(r, e, t) {
  return e == 0 ? r.cutByIndex(t, r.childCount) : r.replaceChild(0, r.firstChild.copy(se(r.firstChild.content, e - 1, t)));
}
function oe(r, e, t) {
  return e == 0 ? r.append(t) : r.replaceChild(r.childCount - 1, r.lastChild.copy(oe(r.lastChild.content, e - 1, t)));
}
function Fe(r, e) {
  for (let t = 0; t < e; t++)
...
function Gt(r, e, t) {
  if (e <= 0)
    return r;
  let n = r.content;
  return e > 1 && (n = n.replaceChild(0, Gt(n.firstChild, e - 1, n.childCount == 1 ? t - 1 : 0))), e > 0 && (n = r.type.contentMatch.fillBefore(n).append(n), t <= 0 && (n = n.append(r.type.contentMatch.matchFragment(n).fillBefore(y.empty, !0)))), r.copy(n);
}
function Pe(r, e, t, n, i) {
  ...
  return l && !Qn(t, s.content, o) ? l : null;
}
function Qn(r, e, t) {
...
class ae extends O {
  ...
  */
  ...
  apply(e) {
    ...
    return C.fromReplace(e, this.pos, this.pos + 1, new x(y.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return R.empty;
  }
...
class Oe extends O {
  ...
  */
  ...
  invert(e) {
    return new Oe(this.attr, e.attrs[this.attr]);
  }
  map(e) {
    return this;
  }
...
class w {
  ...
  */
  constructor(e, t, n) {
    this.$anchor = e, this.$head = t, this.ranges = n || [new Xn(e.min(t), e.max(t))];
  }
  /**
  ...
  */
  static findFrom(e, t, n = !1) {
    let i = e.parent.inlineContent ? new b(e) : te(e.node(0), e.parent, e.pos, e.index(), t, n);
    if (i)
      return i;
  ...
  */
  static atEnd(e) {
    return te(e, e, e.content.size, e.childCount, -1) || new z(e);
  }
  /**
...
class b extends w {
  ...
  */
  static between(e, t, n) {
    ...
    return e.parent.inlineContent || (i == 0 ? e = t : (e = (w.findFrom(e, -n, !0) || w.findFrom(e, n, !0)).$anchor, e.pos < t.pos != i < 0 && (e = t))), new b(e, t);
  }
}
w.jsonID("text", b);
class Re {
...
class Ge {
  ...
  map(e) {
    ...
    return t ? new Re(n, n) : new Ge(n);
  }
  resolve(e) {
    let t = e.resolve(this.anchor), n = t.nodeAfter;
    return n && S.isSelectable(n) ? new S(t) : w.near(t);
  }
}
class z extends w {
  /**
...
function te(r, e, t, n, i, s = !1) {
  ...
  for (let o = n - (i > 0 ? 0 : 1); i > 0 ? o < e.childCount : o >= 0; o += i) {
    ...
    if (l.isAtom) {
      ...
      let a = te(r, l, t + i, i < 0 ? l.childCount : 0, i, s);
      if (a)
        return a;
    }
    t += l.nodeSize * i;
...
class me {
  constructor(e, t, n) {
    this.name = e, this.init = kt(t.init, n), this.apply = kt(t.apply, n);
  }
}
new me("doc", {
  init(r) {
...
function Qt(r, e, t) {
  for (let n in r) {
    let i = r[n];
    i instanceof Function ? i = i.bind(e) : n == "handleDOMEvents" && (i = Qt(i, e, {})), t[n] = i;
  }
  return t;
}
class Z {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Qt(e.props, this, this.props), this.key = e.key ? e.key.key : Xt("plugin");
  }
  /**
...
const Zt = (r, e, t) => {
  ...
  let i = Xe(n);
  if (!i) {
    let o = n.blockRange(), l = o && ie(o);
    return l == null ? !1 : (e && e(r.tr.lift(o, l).scrollIntoView()), !0);
  }
  let s = i.nodeBefore;
  if (an(r, i, e, -1))
    return !0;
  if (n.parent.content.size == 0 && (re(s, "end") || S.isSelectable(s)))
    for (let o = n.depth; ; o--) {
      let l = Ue(r.doc, n.before(o), n.after(o), x.empty);
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = r.tr.step(l);
          a.setSelection(re(s, "end") ? w.findFrom(a.doc.resolve(a.mapping.map(i.pos, -1)), -1) : S.create(a.doc, i.pos - s.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
const nn = (r, e, t) => {
  ...
  if (an(r, i, e, 1))
    return !0;
  if (n.parent.content.size == 0 && (re(s, "start") || S.isSelectable(s))) {
    let o = Ue(r.doc, n.before(), n.after(), x.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = r.tr.step(o);
        l.setSelection(re(s, "start") ? w.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : S.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const er = (r, e) => {
  ...
  if (n) {
    if (t.node.isTextblock || !Y(r.doc, t.from))
      return !1;
    i = t.from;
  ...
  let t = r.selection, n;
  if (t instanceof S) {
    if (t.node.isTextblock || !Y(r.doc, t.to))
      return !1;
    n = t.to;
  ...
  let { $from: t, $to: n } = r.selection, i = t.blockRange(n), s = i && ie(i);
...
function ir(r) {
  return (e, t) => {
    ...
    if (e.selection instanceof S && e.selection.node.isBlock)
      return !n.parentOffset || !j(e.doc, n.pos) ? !1 : (t && t(e.tr.split(n.pos).scrollIntoView()), !0);
    if (!n.depth)
      return !1;
    let s = [], o, l, a = !1, c = !1;
    for (let h = n.depth; ; h--)
      if (n.node(h).isBlock) {
        a = n.end(h) == n.pos + (n.depth - h), c = n.start(h) == n.pos - (n.depth - h), l = Ze(n.node(h - 1).contentMatchAt(n.indexAfter(h - 1))), s.unshift(a && l ? { type: l } : null), o = h;
        break;
      } else {
        if (h == 1)
          return !1;
    ...
    let f = e.tr;
    (e.selection instanceof b || e.selection instanceof z) && f.deleteSelection();
    let u = f.mapping.map(n.pos), d = j(f.doc, u, s.length, s);
    if (d || (s[0] = l ? { type: l } : null, d = j(f.doc, u, s.length, s)), !d)
      return !1;
    if (f.split(u, s.length, s), !a && c && n.node(o).type != l) {
      let h = f.mapping.map(n.before(o)), m = f.doc.resolve(h);
...
function lr(r, e, t) {
  ...
  return !n || !i || !n.type.compatibleContent(i.type) ? !1 : !n.content.size && e.parent.canReplace(s - 1, s) ? (t && t(r.tr.delete(e.pos - n.nodeSize, e.pos).scrollIntoView()), !0) : !e.parent.canReplace(s, s + 1) || !(i.isTextblock || Y(r.doc, e.pos)) ? !1 : (t && t(r.tr.join(e.pos).scrollIntoView()), !0);
}
function an(r, e, t, n) {
  ...
  if (c && (o = (l = i.contentMatchAt(i.childCount)).findWrapping(s.type)) && l.matchType(o[0] || s.type).validEnd) {
    if (t) {
      let h = e.pos + s.nodeSize, m = y.empty;
      for (let k = o.length - 1; k >= 0; k--)
        m = y.from(o[k].create(null, m));
      m = y.from(i.copy(m));
      let p = r.tr.step(new A(e.pos - 1, h, e.pos, h, new x(m, 1, 0), o.length, !0)), g = p.doc.resolve(h + 2 * o.length);
      g.nodeAfter && g.nodeAfter.type == i.type && Y(p.doc, g.pos) && p.join(g.pos), t(p.scrollIntoView());
    }
    return !0;
  }
  let f = s.type.spec.isolating || n > 0 && a ? null : w.findFrom(e, 1), u = f && f.$from.blockRange(f.$to), d = u && ie(u);
  if (d != null && d >= e.depth)
    return t && t(r.tr.lift(u, d).scrollIntoView()), !0;
  if (c && re(s, "start", !0) && re(i, "end")) {
    let h = i, m = [];
    ...
    if (h.canReplace(h.childCount, h.childCount, p.content)) {
      if (t) {
        ...
        for (let I = m.length - 1; I >= 0; I--)
          k = y.from(m[I].copy(k));
        let T = r.tr.step(new A(e.pos - m.length, e.pos + s.nodeSize, e.pos + g, e.pos + s.nodeSize - g, new x(k, m.length, 0), 0, !0));
        t(T.scrollIntoView());
      }
      return !0;
    }
...
function hr(r, e, t, n = null) {
  ...
  if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(t) && e.startIndex == 0) {
    ...
    s = new Ce(a, a, e.depth), e.endIndex < e.parent.childCount && (e = new Ce(e.$from, o.resolve(e.$to.end(e.depth)), e.depth)), i = !0;
  }
  let l = Kt(s, t, n, e);
  return l ? (r && dr(r, e, l, i, t), !0) : !1;
}
function dr(r, e, t, n, i) {
  ...
  for (let f = e.startIndex, u = e.endIndex, d = !0; f < u; f++, d = !1)
    !d && j(r.doc, a, l) && (r.split(a, l), a += 2 * l), a += c.child(f).nodeSize;
  return r;
}
function pr(r) {
  return function(e, t) {
    let { $from: n, $to: i } = e.selection, s = n.blockRange(i, (o) => o.childCount > 0 && o.firstChild.type == r);
    return s ? t ? n.node(s.depth - 1).type == r ? mr(e, t, r, s) : yr(e, t, s) : !0 : !1;
  };
}
function mr(r, e, t, n) {
  let i = r.tr, s = n.end, o = n.$to.end(n.depth);
  s < o && (i.step(new A(s - 1, o, s, o, new x(y.from(t.create(null, n.parent.copy())), 1, 0), 1, !0)), n = new Ce(i.doc.resolve(n.$from.pos), i.doc.resolve(o), n.depth));
  const l = ie(n);
  if (l == null)
    return !1;
  i.lift(n, l);
...
function yr(r, e, t) {
  ...
  for (let h = t.end, m = t.endIndex - 1, p = t.startIndex; m > p; m--)
  ...
  return n.step(new A(u - (l ? 1 : 0), d + (a ? 1 : 0), u + 1, d - 1, new x((l ? y.empty : y.from(i.copy(y.empty))).append(a ? y.empty : y.from(i.copy(y.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(n.scrollIntoView()), !0;
}
function gr(r) {
  return function(e, t) {
    ...
    if (a.type != r)
      return !1;
    if (t) {
      let c = a.lastChild && a.lastChild.type == l.type, f = y.from(c ? r.create() : null), u = new x(y.from(r.create(null, y.from(l.type.create(null, f)))), c ? 3 : 1, 0), d = s.start, h = s.end;
  ...
  createChain(e, t = !0) {
    const { rawCommands: n, editor: i, state: s } = this, { view: o } = i, l = [], a = !!e, c = e || s.tr, f = () => (!a && t && !c.getMeta("preventDispatch") && !this.hasCustomState && o.dispatch(c), l.every((d) => d === !0)), u = {
      ...Object.fromEntries(Object.entries(n).map(([d, h]) => [d, (...p) => {
        const g = this.buildProps(c, t), k = h(...p)(g);
        return l.push(k), u;
      }])),
      run: f
    };
...
function F(r, e = void 0, ...t) {
  return Sr(r) ? e ? r.bind(e)(...t) : r(...t) : r;
}
function br(r) {
...
function et(r, e) {
  const t = { ...r };
  return ye(r) && ye(e) && Object.keys(e).forEach((n) => {
    ye(e[n]) && ye(r[n]) ? t[n] = et(r[n], e[n]) : t[n] = e[n];
  }), t;
}
class Ie {
  constructor(e = {}) {
    this.type = "mark", this.name = "mark", this.parent = null, this.child = null, this.config = {
      ...
      ...this.config,
      ...e
    }, this.name = this.config.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`), this.options = this.config.defaultOptions, this.config.addOptions && (this.options = F(B(this, "addOptions", {
      name: this.name
    }))), this.storage = F(B(this, "addStorage", {
      name: this.name,
  ...
  configure(e = {}) {
    const t = this.extend({
      ...this.config,
      addOptions: () => et(this.options, e)
    });
    return t.name = this.name, t.parent = this.parent, t;
  }
  extend(e = {}) {
    const t = new Ie(e);
    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = F(B(t, "addOptions", {
      name: t.name
    })), t.storage = F(B(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
      ...
      new Z({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: r } = this, { state: e, schema: t } = r, { doc: n, selection: i } = e, { ranges: s } = i, o = Math.min(...s.map((f) => f.$from.pos)), l = Math.max(...s.map((f) => f.$to.pos)), a = Or(t);
            return Er(n, { from: o, to: l }, {
...
const Ir = () => ({ editor: r, view: e }) => (requestAnimationFrame(() => {
  var t;
  r.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), Tr = (r = !1) => ({ commands: e }) => e.setContent("", r), Ar = () => ({ state: r, tr: e, dispatch: t }) => {
...
}, Nr = (r) => (e) => r(e), Rr = () => ({ state: r, dispatch: e }) => on(r, e), zr = (r, e) => ({ editor: t, tr: n }) => {
  const { state: i } = t, s = i.doc.slice(r.from, r.to);
  n.deleteRange(r.from, r.to);
  const o = n.mapping.map(e);
  return n.insert(o, s.content), n.setSelection(new b(n.doc.resolve(o - 1))), !0;
}, Br = () => ({ tr: r, dispatch: e }) => {
  ...
  return !1;
}, Pr = (r) => ({ tr: e, dispatch: t }) => {
  const { from: n, to: i } = r;
  return t && e.delete(n, i), !0;
}, Jr = () => ({ state: r, dispatch: e }) => Qe(r, e), $r = () => ({ commands: r }) => r.keyboardShortcut("Enter"), Dr = () => ({ state: r, dispatch: e }) => rr(r, e);
function Te(r, e, t = { strict: !0 }) {
  const n = Object.keys(e);
  return n.length ? n.every((i) => t.strict ? e[i] === r[i] : br(e[i]) ? e[i].test(r[i]) : e[i] === r[i]) : !0;
}
function un(r, e, t = {}) {
  return r.find((n) => n.type === e && Te(
...
function tt(r, e, t) {
  ...
  if ((!i.node || !i.node.marks.some((f) => f.type === e)) && (i = r.parent.childBefore(r.parentOffset)), !i.node || !i.node.marks.some((f) => f.type === e) || (t = t || ((n = i.node.marks[0]) === null || n === void 0 ? void 0 : n.attrs), !un([...i.node.marks], e, t)))
    return;
...
function Wr(r, e = null) {
  if (!e)
    return null;
  const t = w.atStart(r), n = w.atEnd(r);
  if (e === "start" || e === !0)
    return t;
  if (e === "end")
    return n;
  const i = t.from, s = n.to;
  return e === "all" ? b.create(r, U(0, i, s), U(r.content.size, i, s)) : b.create(r, U(e, i, s), U(e, i, s));
}
function Vr() {
...
const qr = (r = null, e = {}) => ({ editor: t, view: n, tr: i, dispatch: s }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  const o = () => {
    (nt() || Vr()) && n.dom.focus(), requestAnimationFrame(() => {
      t.isDestroyed || (n.focus(), e != null && e.scrollIntoView && t.commands.scrollIntoView());
    });
  };
  if (n.hasFocus() && r === null || r === !1)
    return !0;
  if (s && r === null && !hn(t.state.selection))
    return o(), !0;
  const l = Wr(i.doc, r) || t.state.selection, a = t.state.selection.eq(l);
  return s && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), o()), !0;
}, Hr = (r, e) => (t) => r.every((n, i) => e(n, { ...t, index: i })), Kr = (r, e) => ({ tr: t, commands: n }) => n.insertContentAt({ from: t.selection.from, to: t.selection.to }, r, e), dn = (r) => {
  const e = r.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const n = e[t];
    n.nodeType === 3 && n.nodeValue && /^(\n\s\s|\n)$/.test(n.nodeValue) ? r.removeChild(n) : n.nodeType === 1 && dn(n);
  }
  return r;
};
function ge(r) {
...
function Ae(r, e, t) {
  if (r instanceof $ || r instanceof y)
    return r;
  t = {
    slice: !0,
    parseOptions: {},
  ...
  if (n)
    try {
      ...
      return console.warn("[tiptap warn]: Invalid content.", "Passed value:", r, "Error:", s), Ae("", e, t);
    }
  if (i) {
    if (t.errorOnInvalidContent) {
      let o = !1, l = "";
      ...
      if (t.slice ? ne.fromSchema(a).parseSlice(ge(r), t.parseOptions) : ne.fromSchema(a).parse(ge(r), t.parseOptions), t.errorOnInvalidContent && o)
        throw new Error("[tiptap error]: Invalid HTML content", { cause: new Error(`Invalid element found: ${l}`) });
    }
    const s = ne.fromSchema(e);
    return t.slice ? s.parseSlice(ge(r), t.parseOptions).content : s.parse(ge(r), t.parseOptions);
  }
  return Ae("", e, t);
}
function Ur(r, e, t) {
...
const Gr = (r) => !("type" in r), Qr = (r, e, t) => ({ tr: n, dispatch: i, editor: s }) => {
  var o;
  if (i) {
    t = {
    ...
    let { from: a, to: c } = typeof r == "number" ? { from: r, to: r } : { from: r.from, to: r.to }, f = !0, u = !0;
    if ((Gr(l) ? l : [l]).forEach((m) => {
      m.check(), f = f ? m.isText && m.marks.length === 0 : !1, u = u ? m.isBlock : !1;
    }), a === c && u) {
      const { parent: m } = n.doc.resolve(a);
      m.isTextblock && !m.type.spec.code && !m.childCount && (a -= 1, c += 1);
    }
    let h;
    if (f) {
      if (Array.isArray(e))
    ...
    t.updateSelection && Ur(n, n.steps.length - 1, -1), t.applyInputRules && n.setMeta("applyInputRules", { from: a, text: h }), t.applyPasteRules && n.setMeta("applyPasteRules", { from: a, text: h });
  }
  return !0;
}, Xr = () => ({ state: r, dispatch: e }) => er(r, e), Yr = () => ({ state: r, dispatch: e }) => tr(r, e), Zr = () => ({ state: r, dispatch: e }) => Zt(r, e), _r = () => ({ state: r, dispatch: e }) => nn(r, e), ei = () => ({ state: r, dispatch: e, tr: t }) => {
  try {
...
}, ni = () => ({ state: r, dispatch: e }) => Zn(r, e), ri = () => ({ state: r, dispatch: e }) => _n(r, e);
function pn() {
...
const si = (r) => ({ editor: e, view: t, tr: n, dispatch: i }) => {
  const s = ii(r).split(/-(?!$)/), o = s.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: o === "Space" ? " " : o,
...
function rt(r, e, t = {}) {
  ...
  const a = i - n, c = l.filter((u) => o ? o.name === u.node.type.name : !0).filter((u) => Te(u.node.attrs, t, { strict: !1 }));
  return s ? !!c.length : c.reduce((u, d) => u + d.to - d.from, 0) >= a;
}
const oi = (r, e = {}) => ({ state: t, dispatch: n }) => {
  const i = E(r, t.schema);
  return rt(t, i, e) ? nr(t, n) : !1;
}, li = () => ({ state: r, dispatch: e }) => ln(r, e), ai = (r) => ({ state: e, dispatch: t }) => {
  const n = E(r, e.schema);
  return pr(n)(e, t);
}, ci = () => ({ state: r, dispatch: e }) => sn(r, e);
function mn(r, e) {
...
const fi = (r, e) => ({ tr: t, state: n, dispatch: i }) => {
  let s = null, o = null;
  ...
  return l ? (l === "node" && (s = E(r, n.schema)), l === "mark" && (o = V(r, n.schema)), i && t.selection.ranges.forEach((a) => {
    n.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, f) => {
      s && s === c.type && t.setNodeMarkup(f, void 0, bt(c.attrs, e)), o && c.marks.length && c.marks.forEach((u) => {
        o === u.type && t.addMark(f, f + c.nodeSize, o.create(bt(u.attrs, e)));
      });
    });
  }), !0) : !1;
}, ui = () => ({ tr: r, dispatch: e }) => (e && r.scrollIntoView(), !0), hi = () => ({ tr: r, dispatch: e }) => {
  if (e) {
    const t = new z(r.doc);
    r.setSelection(t);
  }
  return !0;
}, di = () => ({ state: r, dispatch: e }) => en(r, e), pi = () => ({ state: r, dispatch: e }) => rn(r, e), mi = () => ({ state: r, dispatch: e }) => or(r, e), yi = () => ({ state: r, dispatch: e }) => cr(r, e), gi = () => ({ state: r, dispatch: e }) => ar(r, e);
function xi(r, e, t = {}, n = {}) {
  return Ae(r, e, {
    slice: !1,
    parseOptions: t,
...
const ki = (r, e = !1, t = {}, n = {}) => ({ editor: i, tr: s, dispatch: o, commands: l }) => {
  var a, c;
  const { doc: f } = s;
  if (t.preserveWhitespace !== "full") {
    const u = xi(r, i.schema, t, {
...
function it(r) {
  return (e) => bi(e.$from, r);
}
function yn(r, e, t) {
  const n = [];
  return r === e ? t.resolve(r).marks().forEach((i) => {
    const s = t.resolve(r), o = tt(s, i.type);
    o && n.push({
      mark: i,
      ...o
    });
...
function vi(r, e, t = {}) {
  ...
  if (n)
    return !!(r.storedMarks || r.selection.$from.marks()).filter((u) => s ? s.name === u.type.name : !0).find((u) => Te(u.attrs, t, { strict: !1 }));
  let o = 0;
  const l = [];
  if (i.forEach(({ $from: u, $to: d }) => {
    const h = u.pos, m = d.pos;
    r.doc.nodesBetween(h, m, (p, g) => {
      if (!p.isText && !p.marks.length)
        return;
      const k = Math.max(h, g), T = Math.min(m, g + p.nodeSize), I = T - k;
      o += I, l.push(...p.marks.map((D) => ({
        mark: D,
        from: k,
        to: T
      })));
...
function vt(r, e) {
  const { nodeExtensions: t } = kr(e), n = t.find((o) => o.name === r);
  if (!n)
    return !1;
  const i = {
    name: n.name,
...
function gn(r, { checkChildren: e = !0, ignoreWhitespace: t = !1 } = {}) {
  ...
  if (e) {
    ...
    return r.content.forEach((s) => {
      i !== !1 && (gn(s, { ignoreWhitespace: t, checkChildren: e }) || (i = !1));
    }), i;
  }
  return !1;
}
  ...
  return o.some(({ $from: l, $to: a }) => {
    ...
    return r.doc.nodesBetween(l.pos, a.pos, (f, u, d) => {
      if (c)
        return !1;
      if (f.isInline) {
        const h = !d || d.type.allowsMarkType(t), m = !!t.isInSet(f.marks) || !f.marks.some((p) => p.type.excludes(t));
        c = h && m;
      }
      return !c;
    }), c;
...
const Mi = (r, e = {}) => ({ tr: t, state: n, dispatch: i }) => {
    ...
    if (o) {
      ...
      l.forEach((c) => {
        ...
        n.doc.nodesBetween(f, u, (d, h) => {
          const m = Math.max(h, f), p = Math.min(h + d.nodeSize, u);
          d.marks.find((k) => k.type === a) ? d.marks.forEach((k) => {
            a === k.type && t.addMark(m, p, a.create({
              ...k.attrs,
              ...e
            }));
  ...
  return Ci(n, t, a);
}, Ei = (r, e) => ({ tr: t }) => (t.setMeta(r, e), !0), Oi = (r, e = {}) => ({ state: t, dispatch: n, chain: i }) => {
  ...
  if (t) {
    const { doc: n } = e, i = U(r, 0, n.content.size), s = S.create(n, i);
    e.setSelection(s);
  }
  return !0;
}, Ti = (r) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: n } = e, { from: i, to: s } = typeof r == "number" ? { from: r, to: r } : r, o = b.atStart(n).from, l = b.atEnd(n).to, a = U(i, o, l), c = U(s, o, l), f = b.create(n, a, c);
    e.setSelection(f);
  }
  return !0;
}, Ai = (r) => ({ state: e, dispatch: t }) => {
  const n = E(r, e.schema);
  return gr(n)(e, t);
};
function Ct(r, e) {
...
const Ni = ({ keepMarks: r = !0 } = {}) => ({ tr: e, state: t, dispatch: n, editor: i }) => {
  const { selection: s, doc: o } = e, { $from: l, $to: a } = s, c = i.extensionManager.attributes, f = we(c, l.node().type.name, l.node().attrs);
  if (s instanceof S && s.node.isBlock)
    return !l.parentOffset || !j(o, l.pos) ? !1 : (n && (r && Ct(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  const u = a.parentOffset === a.parent.content.size, d = l.depth === 0 ? void 0 : Si(l.node(-1).contentMatchAt(l.indexAfter(-1)));
  let h = u && d ? [
    {
      type: d,
      attrs: f
    }
  ] : void 0, m = j(e.doc, e.mapping.map(l.pos), 1, h);
  if (!h && !m && j(e.doc, e.mapping.map(l.pos), 1, d ? [{ type: d }] : void 0) && (m = !0, h = d ? [
    {
      type: d,
      attrs: f
    }
  ] : void 0), n) {
    if (m && (s instanceof b && e.deleteSelection(), e.split(e.mapping.map(l.pos), 1, h), d && !u && !l.parentOffset && l.parent.type !== d)) {
    ...
    r && Ct(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return m;
}, Ri = (r, e = {}) => ({ tr: t, state: n, dispatch: i, editor: s }) => {
  var o;
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      for (let W = a.depth - T; W >= a.depth - 3; W -= 1)
        k = y.from(a.node(W).copy(k));
      const I = a.indexAfter(-1) < a.node(-2).childCount ? 1 : a.indexAfter(-2) < a.node(-3).childCount ? 2 : 3, D = {
        ...we(d, a.node().type.name, a.node().attrs),
        ...e
      }, J = ((o = l.contentMatch.defaultType) === null || o === void 0 ? void 0 : o.createAndFill(D)) || void 0;
      k = k.append(y.from(l.createAndFill(null, J) || void 0));
      const L = a.before(a.depth - (T - 1));
      t.replace(L, a.after(-I), new x(k, 4 - T, 0));
      let ee = -1;
      t.doc.nodesBetween(L, t.doc.content.size, (W, xn) => {
        if (ee > -1)
          return !1;
        W.isTextblock && W.content.size === 0 && (ee = xn + 1);
      }), ee > -1 && t.setSelection(b.near(t.doc.resolve(ee))), t.scrollIntoView();
    }
    return !0;
  }
  const h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null, m = {
    ...we(d, u.type.name, u.attrs),
    ...e
  }, p = {
    ...we(d, a.node().type.name, a.node().attrs),
    ...e
  ...
  if (!j(t.doc, a.pos, 2))
    return !1;
  if (i) {
    const { selection: k, storedMarks: T } = n, { splittableMarks: I } = s.extensionManager, D = T || k.$to.parentOffset && k.$from.marks();
    if (t.split(a.pos, 2, g).scrollIntoView(), !D || !i)
      return !0;
    const J = D.filter((L) => I.includes(L.type.name));
    t.ensureMarks(J);
  }
  return !0;
}, De = (r, e) => {
  ...
  return t.node.type === (i == null ? void 0 : i.type) && Y(r.doc, t.pos) && r.join(t.pos), !0;
}, Le = (r, e) => {
  const t = it((o) => o.type === e)(r.selection);
  if (!t)
    return !0;
  ...
  if (n === void 0)
    return !0;
  const i = r.doc.nodeAt(n);
  return t.node.type === (i == null ? void 0 : i.type) && Y(r.doc, n) && r.join(n), !0;
}, zi = (r, e, t, n = {}) => ({ editor: i, tr: s, state: o, dispatch: l, chain: a, commands: c, can: f }) => {
  const { extensions: u, splittableMarks: d } = i.extensionManager, h = E(r, o.schema), m = E(e, o.schema), { selection: p, storedMarks: g } = o, { $from: k, $to: T } = p, I = k.blockRange(T), D = g || p.$to.parentOffset && p.$from.marks();
  if (!I)
    return !1;
  const J = it((L) => vt(L.type.name, u))(p);
  if (I.depth >= 1 && J && I.depth - J.depth <= 1) {
    if (J.node.type === h)
      return c.liftListItem(m);
    if (vt(J.node.type.name, u) && h.validContent(J.node.content) && l)
      return a().command(() => (s.setNodeMarkup(J.pos, h), !0)).command(() => De(s, h)).command(() => Le(s, h)).run();
  }
  return !t || !D || !l ? a().command(() => f().wrapInList(h, n) ? !0 : c.clearNodes()).wrapInList(h, n).command(() => De(s, h)).command(() => Le(s, h)).run() : a().command(() => {
    const L = f().wrapInList(h, n), ee = D.filter((W) => d.includes(W.type.name));
    return s.ensureMarks(ee), L ? !0 : c.clearNodes();
  }).wrapInList(h, n).command(() => De(s, h)).command(() => Le(s, h)).run();
}, Bi = (r, e = {}, t = {}) => ({ state: n, commands: i }) => {
  const { extendEmptyMarkRange: s = !1 } = t, o = V(r, n.schema);
  return vi(n, o, e) ? i.unsetMark(o, { extendEmptyMarkRange: s }) : i.setMark(o, e);
}, Fi = (r, e, t = {}) => ({ state: n, commands: i }) => {
...
}, Pi = (r, e = {}) => ({ state: t, commands: n }) => {
  const i = E(r, t.schema);
  return rt(t, i, e) ? n.lift(i) : n.wrapIn(i, e);
}, Ji = () => ({ state: r, dispatch: e }) => {
  const t = r.plugins;
  for (let n = 0; n < t.length; n += 1) {
    const i = t[n];
    let s;
  ...
  if (f && o) {
    let { from: d, to: h } = l;
    const m = (s = c.marks().find((g) => g.type === a)) === null || s === void 0 ? void 0 : s.attrs, p = tt(c, a, m);
  ...
  return l ? (l === "node" && (s = E(r, n.schema)), l === "mark" && (o = V(r, n.schema)), i && t.selection.ranges.forEach((a) => {
    ...
    t.selection.empty ? n.doc.nodesBetween(c, f, (p, g) => {
      s && s === p.type && (h = Math.max(g, c), m = Math.min(g + p.nodeSize, f), u = g, d = p);
    }) : n.doc.nodesBetween(c, f, (p, g) => {
      g < c && s && s === p.type && (h = Math.max(g, c), m = Math.min(g + p.nodeSize, f), u = g, d = p), g >= c && g <= f && (s && s === p.type && t.setNodeMarkup(g, void 0, {
        ...p.attrs,
        ...e
      }), o && p.marks.length && p.marks.forEach((k) => {
        if (o === k.type) {
          const T = Math.max(g, c), I = Math.min(g + p.nodeSize, f);
          t.addMark(T, I, o.create({
            ...k.attrs,
            ...e
          }));
        }
      ...
      o === p.type && t.addMark(h, m, o.create({
        ...p.attrs,
        ...e
      }));
    }));
...
var Vi = /* @__PURE__ */ Object.freeze({
  ...
  selectNodeForward: pi,
  selectParentNode: mi,
  selectTextblockEnd: yi,
  selectTextblockStart: gi,
  setContent: ki,
  setMark: Mi,
  setMeta: Ei,
  setNode: Oi,
...
P.create({
  ...
  addKeyboardShortcuts() {
    const r = () => this.editor.commands.first(({ commands: o }) => [
      ...
      () => o.command(({ tr: l }) => {
        const { selection: a, doc: c } = l, { empty: f, $anchor: u } = a, { pos: d, parent: h } = u, m = u.parent.isTextblock && d > 0 ? l.doc.resolve(d - 1) : u, p = m.parent.type.spec.isolating, g = u.pos - u.parentOffset, k = p && m.parent.childCount === 1 ? g === u.pos : w.atStart(c).from === d;
        return !f || !h.type.isTextblock || h.textContent.length || !k || k && u.parent.type.name === "paragraph" ? !1 : o.clearNodes();
      }),
      () => o.deleteSelection(),
      () => o.joinBackward(),
    ...
    return [
      ...
      new Z({
        ...
        appendTransaction: (r, e, t) => {
          ...
          if (!n || i)
            return;
          const { empty: s, from: o, to: l } = e.selection, a = w.atStart(e.doc).from, c = w.atEnd(e.doc).to;
          if (s || !(o === a && l === c) || !gn(t.doc))
            return;
          const d = t.tr, h = fn({
            state: t,
            transaction: d
          ...
          if (m.clearNodes(), !!d.steps.length)
            return d;
        }
      })
    ];
...
function Hi(r) {
  return new vr({
    ...
    handler: ({ state: e, range: t, match: n }) => {
      const i = F(r.getAttributes, void 0, n);
      if (i === !1 || i === null)
        return null;
      const { tr: s } = e, o = n[n.length - 1], l = n[0];
      if (o) {
        const a = l.search(/\S/), c = t.from + l.indexOf(o), f = c + o.length;
        if (yn(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((p) => p === r.type && p !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
        f < t.to && s.delete(f, t.to), c > t.from && s.delete(t.from + a, c);
        const d = t.from + a + o.length;
        s.addMark(t.from + a, d, r.type.create(i || {})), s.removeStoredMark(r.type);
      }
    }
  });
}
function Ki(r) {
  return new Mr({
    ...
    handler: ({ state: e, range: t, match: n, pasteEvent: i }) => {
      const s = F(r.getAttributes, void 0, n, i);
      if (s === !1 || s === null)
        return null;
      ...
      if (l) {
        ...
        if (yn(t.from, t.to, e.doc).filter((m) => m.mark.type.excluded.find((g) => g === r.type && g !== m.mark.type)).filter((m) => m.to > u).length)
          return null;
        d < t.to && o.delete(d, t.to), u > t.from && o.delete(t.from + f, u), c = t.from + f + l.length, o.addMark(t.from + f, c, r.type.create(s || {})), o.removeStoredMark(r.type);
      }
    }
  });
}
const Ui = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Gi = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, Qi = Ie.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
  ...
  renderHTML({ HTMLAttributes: r }) {
    return ["mark", wr(this.options.HTMLAttributes, r), 0];
  },
  addCommands() {
    return {
      setHighlight: (r) => ({ commands: e }) => e.setMark(this.name, r),
      toggleHighlight: (r) => ({ commands: e }) => e.toggleMark(this.name, r),
...
//# sourceMappingURL=index-B_n7MQKu.js.map
