...
* The build output is copied to `wwwroot\App_Plugins\LCCInternetWebReview\lcc-internet-web-review.js`
...
Save https://localhost:44389/umbraco/swagger/review/swagger.json file to C:\Development\LancashireCountyCouncil\Internet\docs\review.swagger.json
npx openapi --input C:\Development\LancashireCountyCouncil\Internet\docs\review.swagger.json --output src/api --useOptions --postfixServices Resource
